...
| `prisma.hosted_runtime_log` | Live delete | Documented only | Deletes the bounded pre-cutover tail of member-scoped runtime logs and redacted runtime JSON. Export omits runtime log rows and counts. |
