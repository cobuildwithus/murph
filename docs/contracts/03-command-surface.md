...
vault-cli assistant cron target set <job> --vault <path> [--toSelf <channel>] [--copyFrom <job>] [--dryRun] [--channel <channel>] [--identity <id>] [--participant <id>] [--sourceThread <id>] [--deliveryTarget <target>] [--request-id <id>]
