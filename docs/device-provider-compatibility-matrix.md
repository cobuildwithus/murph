...
- activity and movement: `daily-steps`, `distance`, `active-calories`, `workout-strain`, `percent-recorded`, `altitude-gain`, `altitude-change`, `floors-climbed`
