...
- Cloudflare-bound hosted execution dispatches from onboarding, hosted share acceptance, hosted email ingress, and hosted device-sync wakes now append canonical hosted ingress rows directly instead of detouring through a second dispatch queue
