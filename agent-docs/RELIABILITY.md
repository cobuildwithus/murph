...
- Hosted growth activity history reuses the authenticated daily growth snapshot
  ...
  revenue, member, and message snapshot fields. A successful attribution pass
  remains authoritative and may replace unknown values or write null when it
  proves retained sender evidence incomplete.
