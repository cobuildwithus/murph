...
| `pnpm test:frontend-design-proof` | Focused Node tests for the pull-request design-proof guard. The guard requires every user-facing hosted-web UI diff to update the reusable-component or composed-section design catalog and to provide hosted desktop and mobile design-page screenshots in the PR body. | `scripts/check-frontend-design-proof.mjs`, `scripts/check-frontend-design-proof.test.mjs`, `.github/workflows/frontend-design-proof.yml`, and `.github/pull_request_template.md` |
