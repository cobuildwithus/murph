...
| --- | --- | --- |
| `pnpm --dir apps/web test:prepared -- member-owned-provider-setup-service.test.ts member-owned-provider-setup-primitive.test.ts member-owned-provider-setup-account-deletion.test.ts member-owned-provider-setup-ui.test.tsx member-owned-provider-setup-migration.test.ts hosted-execution-computer-use.test.ts device-connect-intent-route.test.ts hosted-connect-start.test.ts device-reconnect-link-tool.test.ts hosted-account-data-service.test.ts hosted-health-data-consent-withdrawal.test.ts device-provider-application-ingress-store.test.ts device-provider-application-cleanup.test.ts device-sync-callback-route.test.ts connect-page.test.ts device-sync-settings-routes.test.ts device-sync-internal-connect-route.test.ts production-migration-guard.test.ts hosted-onboarding-privacy-foundation-migration.test.ts changelog.test.ts changelog-page.test.tsx` | Focused Web proof for the reusable model-driven member-owned provider setup owner and Strava's declarative registry entry. | Provider-indexed registry/projection behavior; exact setup-owned browser acquisition and mismatch rejection; typed selector/action restrictions; blind credential capture and sealing; persisted canceling fences; marker-scoped deletion; callback/disconnect outcomes; account-deletion ordering and retry preservation; shared `/connect` UI plus inert design studies; expand-safe migration and changelog contracts. No test in this lane contacts live Strava. |
