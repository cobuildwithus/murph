...
selects only the kind and summary columns with deterministic ordering and an
explicit truncation line at the row cap, observable missing configuration, and
same-hour
