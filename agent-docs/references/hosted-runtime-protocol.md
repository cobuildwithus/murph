...
again. A later workspace checkpoint creates the next refresh identity. Canonical
runtime reconciliation recovers a missed first signal from the durable row.
