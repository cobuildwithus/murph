...
per message, and 36,000 bytes total, then returns to native resume after that
...
fallback—at most 72 messages, 4,000 bytes per message, and 36,000 bytes total—
