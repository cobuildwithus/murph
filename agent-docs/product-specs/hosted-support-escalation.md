...
- The model-authored issue text after the reserved prefix is persisted separately as anonymous feedback. A follow-up Web release may include that stored de-identified text in the account-linked email.
