...
Murph live event when that event is the sole active workout, contains at least
one set, and has no pending set coordinate. It computes the prior end from the
