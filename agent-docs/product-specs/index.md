...
| `agent-docs/product-specs/murph-onboarding.md` | Aspiration-anchored onboarding with a progressive health foundation, contextual return, collaborative first step, finite completion, and one code-owned immediate first personal read. | Active |
