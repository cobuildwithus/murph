...
| `agent-docs/product-specs/hosted-group-join-confirmation.md` | First-join private Murph confirmation for reaction and web joins, with a reply-oriented question and first-party sharing-editor link. | Implemented |
