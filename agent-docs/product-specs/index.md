...
| `agent-docs/product-specs/nutrition-totals-card.md` | Private logged-so-far nutrition cards with optional goals, bounded first introduction, and unchanged target authority. | Implemented; release proof pending |
