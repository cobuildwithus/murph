...
| `agent-docs/product-specs/pulse-trial-checkout-offer.md` | Planned Pulse Trial checkout-offer architecture over the existing hosted billing and AI usage allowance system. | Planned |
| `agent-docs/product-specs/health-commons.md` | Health Commons page graph, catalog, versioning, aggregate outcome summaries, and artifact-storage product boundary. | Active |
...
| `agent-docs/product-specs/protocol-outcome-network.md` | Outcome cards, sharing levels, contribution rules, cohort summaries, and social guardrails for the protocol outcome network. | Active |
