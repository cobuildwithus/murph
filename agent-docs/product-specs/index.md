...
| `agent-docs/product-specs/hosted-plan-usage.md` | Web-owned overall available-usage projection and enforced combined-capacity blocking, including forecast, server-selected actions, group privacy boundaries, and personal or exact Family-member Settings handoffs. | Active |
...
| `agent-docs/product-specs/hosted-usage-topups.md` | Implemented fixed $5/$10/$25 personal and Family Checkout plus explicit saved-card-or-Checkout hosted-group funding over one Murph-owned webhook-fulfilled usage-credit ledger and immediate overall usage-bar refresh. | Active |
