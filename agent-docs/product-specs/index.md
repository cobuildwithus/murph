...
| `agent-docs/product-specs/hosted-plan-usage.md` | Web-owned included-usage projection shared by Settings and the read-only assistant tool, including forecast, action, and group-copy boundaries. | Active |
