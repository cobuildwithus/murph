...
| `agent-docs/product-specs/hosted-group-member-plan.md` | Private $3.50 direct Group subscription for confirmed hosted-group members, with Pulse runtime capability, $2.80 included personal AI usage, trial continuation, signed billing actions, and public-checkout exclusion. | Active |
