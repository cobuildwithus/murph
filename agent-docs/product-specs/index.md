...
| `agent-docs/product-specs/hosted-usage-topups.md` | Implemented fixed $5/$10/$25 Stripe Checkout packs over canonical purchase/referral credit entries and remaining projections, with purchase-only refund and dispute reversal. | Active |
