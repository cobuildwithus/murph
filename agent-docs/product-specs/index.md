...
| `agent-docs/product-specs/hosted-usage-topups.md` | Implemented fixed $5/$10/$25 personal and Family Checkout plus explicit saved-card-or-Checkout hosted-group funding over one Murph-owned webhook-fulfilled usage-credit ledger. | Active |
