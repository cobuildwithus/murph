...
| `docs/hosted-auth-migration.md` | Four-stage Privy removal, transition-only import, encrypted Better Auth sessions, approved credential changes, saved-key recovery, native continuity and guarded schema contraction. | Hosted auth migration rollout | High | 2026-09-10 |
