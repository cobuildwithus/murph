...
| `agent-docs/references/hosted-postgres-runtime.md` | Postgres execution authority, mixed member routing, atomic new-member route creation, durable legacy materialization and creation closure, empty-owner settlement, ordered resumable handoffs and protected hosted operator, native completion, managed uploads, and rolling migration readiness. | Hosted runtime ownership | High | 2026-09-15 |
