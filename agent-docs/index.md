...
| `agent-docs/operations/native-android-hosted-e2e.md` | Protected native Android hosted E2E ownership, exact Web/Android source binding, shared non-production identity and Junction namespace lifecycle, private workflow dispatch lease and cancellation fence, protected environment contract, privacy boundary, rollout order, and physical-device proof gap. | Native Android verification operations | High | 2026-08-20 |
