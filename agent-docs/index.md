...
| `agent-docs/product-specs/personal-group-awareness.md` | Personal Murph read access to hosted-group memberships, including owner discoverability for organic routed groups without implicit vault sharing, requested permissions, active self grants, and owner-authorized permission links. | Hosted group self-awareness | High | 2026-08-25 |
