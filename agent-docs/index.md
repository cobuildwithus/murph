...
| `agent-docs/product-specs/companion-app.md` | Native iOS and Android health companions: broad Apple Health sync plus closed WHOOP enrichment and scheduled overnight PRV on iOS, and a narrow Health Connect bridge with welcome-suppressed admission-before-health signup, normalized auth/trial recovery, typed consent/access/account-conflict handling, explicit connect/resume, and source-scoped backend receipt truth on Android. | Companion app plan | High | 2026-08-06 |
