...
| `packages/core/bench/README.md` | Secret-free Docker device-import CPU reproduction and limits of one-vCPU sizing evidence. | Core import benchmark | Medium | 2026-09-04 |
...
| `agent-docs/operations/pr-reviewgpt-loop.md` | Final PR ReviewGPT loop. | Final PR ReviewGPT loop | Medium | 2026-09-02 |
