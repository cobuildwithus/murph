...
| `agent-docs/references/testing-ci-map.md` | Verification map for packages, apps, smoke flows, exact-head PR CI, protected-main runtime proof, canonical executors, and current coverage owners, including pre-Playwright generated-input preparation for viewport proof. | Testing and CI truth | High | 2026-09-02 |
