...
| `agent-docs/product-specs/personal-patterns.md` | Private context-to-outcome findings, desktop comparisons, and mobile cards with coverage bars, compact neutral results, and detail drawers. | Personal Patterns product spec | High | 2026-09-06 |
