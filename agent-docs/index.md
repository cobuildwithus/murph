...
| `agent-docs/operations/verification-and-runtime.md` | Verification ownership by delivery path, continued base reconciliation, and Temporal integration build/process-shard proof. | Verification policy | High | 2026-09-04 |
...
| `agent-docs/operations/pr-reviewgpt-loop.md` | PR review for realistic serious bugs and material Complexity Collapse, with a three-round review cap, no base-update limit, and response timing and evidence requirements. | Final PR ReviewGPT loop | Medium | 2026-09-04 |
