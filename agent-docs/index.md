...
| `agent-docs/FRONTEND.md` | Frontend implementation guidance for `apps/web`, including design-system sources (`PRODUCT.md`, `DESIGN.md`), model-neutral implementation routing, live component/consent/section proof destinations, representation updates when needed, parent-owned rendered review, and completion-workflow routing. | Current frontend implementation guidance | Medium | 2026-08-31 |
