...
| `packages/vault-usecases/bench/wearable-sources.md` | Paired public-usecase source-health benchmark: reusable wearable projection, repeated reads, invalidating writes, both composed read orders, output hashes and unmeasured handoff limits. | Source-health performance | Medium | 2026-09-13 |
| `agent-docs/exec-plans/active/2026-09-13-source-list-projection-independence.md` | Active wearable-projection reuse handoff; exact manifest freshness, atomic partial publication, composed-workload proof, and parent-owned validation/Git completion. | Source-health execution plan | Medium | 2026-09-13 |
