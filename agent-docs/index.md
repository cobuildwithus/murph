...
| `agent-docs/operations/agent-workflow-routing.md` | Workflow router and compact agent work contract for task classes, proportional Product UX planning and walkthrough routing, action authority, evidence/tool use, focused local PR proof with exact-head CI ownership, review gates, commit paths, worktree isolation, and safe retirement. | Agent workflow routing | High | 2026-08-17 |
| `agent-docs/operations/product-ux.md` | Single owner for proportional Product UX planning, post-code walkthroughs, and preliminary review across affected people, minimum useful value, known context, complete journeys, weak states, required UI screenshot evidence, and evidence-backed finding levels. | Product UX workflow | High | 2026-08-19 |
| `agent-docs/operations/verification-and-runtime.md` | Verification ownership by delivery path, including focused local proof, broad exact-head CI for PRs, required native iOS hosted E2E proof with namespace-only cleanup inside a disposable shared Junction sandbox, required UI screenshot evidence, canonical command and executor semantics, runtime proof boundaries, and package/app testing surfaces. | Verification policy | High | 2026-08-19 |
...
| `agent-docs/operations/completion-workflow.md` | Outcome-based completion with proportional Product UX plans and walkthroughs, required UI screenshot evidence, a short PR contract with a required deployment-concerns disposition and conditional risk details, exact-head specialist review, focused local proof, broad PR CI, scoped commit and plan closure, and merge-readiness handoff. | Completion workflow | High | 2026-08-19 |
