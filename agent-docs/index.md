...
| `agent-docs/operations/completion-workflow.md` | Outcome-based completion with proportional Product UX plans and walkthroughs, literal frontend evidence labels, a narrow static route-metadata proof exemption, a short PR contract with required changelog and deployment dispositions, an ordered PR-gate launch preflight, exact-head specialist review, focused local proof, broad PR CI, scoped commit and plan closure, and merge-readiness handoff. | Completion workflow | High | 2026-08-20 |
