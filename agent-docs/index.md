...
| `docs/hosted-auth-migration.md` | Staged Privy removal, encrypted Better Auth backend, Ops import, approved credential changes, shared account connections, session/native continuity and retirement gates. | Hosted auth migration rollout | High | 2026-09-09 |
