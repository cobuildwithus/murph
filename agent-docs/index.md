...
| `docs/assistant-outbox-lookups.md` | Canonical-authoritative disposable outbox lookup projection, generation publication, mixed-writer rollout/rollback floor, bounded maintenance, and fallback contract. | Assistant outbox derived-state ownership | High | 2026-08-18 |
