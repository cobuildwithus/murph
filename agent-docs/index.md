...
| `agent-docs/research/murph-age-autoresearch.md` | Murph Age autoresearch operating rules, including the ReviewGPT-vs-Codex role split, transition gates, and source/privacy boundaries. | Murph Age research workflow | High | 2026-05-08 |
...
| `agent-docs/operations/verification-and-runtime.md` | Verification rules, runtime assumptions, and doc-gardening scope for repo work. | Verification policy | High | 2026-05-02 |
