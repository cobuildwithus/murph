...
| `agent-docs/product-specs/personal-patterns.md` | Private context-to-outcome findings, desktop comparisons, and mobile cards with collapsed neutral results, tappable coverage, and comparison sample sizes. | Personal Patterns product spec | High | 2026-09-06 |
