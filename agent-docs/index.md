...
| `agent-docs/product-specs/public-goal-guides.md` | Public outcome-first Goal guides, canonical grouping and SEO, editable messaging handoff, private setup workflow, exact page/workflow lineage, and the strict-lineage runner rollout floor. | Goal guide behavior | High | 2026-08-30 |
