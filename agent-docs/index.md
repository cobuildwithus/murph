...
| `agent-docs/product-specs/public-goal-guides.md` | Public outcome-first Goal guides, canonical grouping and SEO, editable messaging handoff, private setup workflow, and exact page/workflow lineage. | Goal guide behavior | High | 2026-08-30 |
