...
| `agent-docs/operations/pr-reviewgpt-loop.md` | PR review for realistic serious bugs and material Complexity Collapse, with response timing and evidence requirements. | Final PR ReviewGPT loop | Medium | 2026-09-04 |
