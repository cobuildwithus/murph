...
| `agent-docs/product-specs/starter-usage.md` | Non-expiring $4.50 starter usage, text entry, image card access, and abuse alerts. | Hosted access/billing product spec | High | 2026-09-10 |
