...
revision binding, member-locked OAuth/deletion serialization, invocation-scoped credential projection, exact token-return
...
| `agent-docs/compliance/2026-07-23-connected-source-launch-gate.md` | Connected-source permission assumption, launch status, and ongoing provider controls, including the model-driven member-owned provider setup boundary and pre-suspension external cleanup gate. | Connected-source release gate | High | 2026-08-12 |
