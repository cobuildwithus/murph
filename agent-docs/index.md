...
| `agent-docs/operations/pr-deep-review-loop.md` | Required post-CI external PR deep-review loop: fire `pnpm review:gpt pr-review` per round on a fresh thread, verify each finding before landing it, stop at zero accepted findings or 5 rounds. | PR deep-review loop | Medium | 2026-06-12 |
