...
| `agent-docs/product-specs/personal-patterns.md` | Private context-to-outcome findings, desktop comparisons, and mobile cards with changed results, compact neutral states, tappable coverage, and inline comparison sample sizes. | Personal Patterns product spec | High | 2026-09-06 |
