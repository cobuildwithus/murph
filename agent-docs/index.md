...
| `ARCHITECTURE.md` | Top-level module map, trust boundaries, persisted-state rules, hosted mailbox/checkpoint ownership, hosted Temporal hard-cut pointer, device-sync recovery ownership, control-flow contracts, and package-boundary rules. | Current runtime architecture | High | 2026-05-27 |
...
| `agent-docs/references/testing-ci-map.md` | Verification map for packages, apps, smoke flows, CI, diff-aware package-boundary checks, hosted Temporal orchestration guard coverage, and the Cloudflare immediate-deploy Blacksmith path. | Testing and CI truth | High | 2026-05-21 |
...
| `agent-docs/references/giant-file-composability-seams.md` | Touch-time 1,000-line file limit plus current split-now, worth-planning, and keep-together notes for oversized multi-responsibility files. | Giant-file composability seam guidance | Medium | 2026-06-02 |
...
| `agent-docs/operations/agent-workflow-routing.md` | Workflow router for task classes, plans, audits, verification, commit paths, and touch-time oversized-file handling. | Agent workflow routing | High | 2026-06-02 |
| `agent-docs/operations/verification-and-runtime.md` | Verification rules, build command semantics, hosted Temporal guard coverage, runtime assumptions, and doc-gardening scope for repo work. | Verification policy | High | 2026-05-21 |
...
| `apps/web/README.md` | Hosted web control-plane overview, env/runtime contract, hosted AI usage allowance ownership, and Temporal demand gating boundary. | `apps/web/**` | Medium | 2026-05-27 |
