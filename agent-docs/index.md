...
| `agent-docs/references/hosted-runtime-protocol.md` | Hosted mailbox/workspace checkpoint protocol and deleted run-protocol guardrails. | Hosted execution architecture | High | 2026-04-27 |
