...
| `agent-docs/exec-plans/active/2026-09-14-device-failure-evidence.md` | Bounded private device failure evidence; parent application and verification pending. | Active implementation plan | Medium | 2026-09-14 |
