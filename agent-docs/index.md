...
| `agent-docs/operations/product-ux.md` | Proportional Product UX planning and post-code walkthroughs across affected people, minimum useful value, ordinary entry-to-outcome proof paths, weak states, and risk-based evidence. | Product UX workflow | High | 2026-08-15 |
