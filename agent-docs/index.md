...
| `agent-docs/exec-plans/active/2026-09-22-poll-self-vote.md` | Murph’s own iMessage votes, Telegram spoken picks, and verification; current behavior is owned by `ARCHITECTURE.md`. | Poll participation implementation evidence | Medium | 2026-09-22 |
