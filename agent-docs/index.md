...
| `agent-docs/references/hosted-runtime-protocol.md` | Hosted mailbox/workspace checkpoints, stale delivery-wake recovery, exact ownership and idle restore publication, and accepted-work monitoring boundaries. | Hosted execution architecture | High | 2026-09-08 |
