...
| `packages/runtime-state/README.md` | `.runtime` taxonomy, portability, hosted state rules, and hosted Codex rollout plus validated managed ChatGPT auth snapshot scope. | `packages/runtime-state/**` | Medium | 2026-06-23 |
