...
| `agent-docs/exec-plans/active/2026-09-18-food-search-ranking.md` | PR #3564: native red/green and six-case equivalence confirmed; full native-owner run, exact-head CI, final ReviewGPT, and parent closeout pending. | Active performance correction | Medium | 2026-09-18 |
