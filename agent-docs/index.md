...
| `agent-docs/operations/completion-workflow.md` | Completion workflow and verified-base mergeability gate, including Draft-before-push ordering for candidate updates. | Completion workflow | High | 2026-09-11 |
