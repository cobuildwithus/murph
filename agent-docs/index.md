...
| `docs/hosted-runtime-log-database.md` | Dedicated hosted runtime-log Postgres ownership, deletion fence, reversible authority recheck, retention, migration preflight, and rollback floor. | Hosted runtime observability storage | High | 2026-08-26 |
