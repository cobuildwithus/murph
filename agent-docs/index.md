...
| `agent-docs/operations/stripe-effect-compatibility-cutover.md` | Expand-only Stripe claim compatibility deployment, drain, rollback-floor, removal, and real-PostgreSQL barrier proof. | Hosted billing operations | High | 2026-08-12 |
