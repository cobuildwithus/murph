...
| `agent-docs/references/hosted-runtime-protocol.md` | Hosted mailbox/workspace checkpoint protocol, mailbox import with best-effort inbox projection, Workflow-owned pointer nudge retry ownership, and deleted run-protocol guardrails. | Hosted execution architecture | High | 2026-05-02 |
