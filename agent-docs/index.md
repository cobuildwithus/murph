...
| `agent-docs/exec-plans/active/2026-09-13-browser-vault-refresh-efficiency.md` | Narrow experiment-source hashing and a bounded Browser Vault refresh budget, with synthetic cost and cancellation proof. | Active runtime fix | High | 2026-09-13 |
