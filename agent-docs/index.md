...
| `agent-docs/exec-plans/active/2026-09-18-food-search-ranking.md` | Food-only select-before-ordinal correction, native page/plan regression, and pending parent differential verification. | Active performance correction | Medium | 2026-09-18 |
