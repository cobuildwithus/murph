...
| `agent-docs/references/testing-ci-map.md` | Verification map for packages, apps, smoke flows, CI, diff-aware package-boundary checks, hosted Temporal orchestration guard coverage, hosted web E2E testkit triggers, and the Cloudflare immediate-deploy Blacksmith path. | Testing and CI truth | High | 2026-06-09 |
