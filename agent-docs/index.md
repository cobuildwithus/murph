...
| `agent-docs/product-specs/personal-patterns.md` | Private context-to-outcome findings, desktop comparisons, and mobile measure selection. | Personal Patterns product spec | High | 2026-09-06 |
