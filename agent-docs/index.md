...
| `agent-docs/product-specs/personal-patterns.md` | Private context-to-outcome findings, source-qualified baseline days, several matched controls, retrospective reliability screening, coherent sleep quality, and unchanged cards and drawers. | Personal Patterns product spec | High | 2026-09-10 |
