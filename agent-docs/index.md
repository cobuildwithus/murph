...
| `agent-docs/operations/native-android-hosted-e2e.md` | Native Android six-hour production-canary ownership, successful-SHA checkpoint admission, exact Web/Android source and production-alias binding, immutable private source, refreshable repository-scoped GitHub App credentials, receipted and unreceipted dispatch fencing, privacy boundary, source rotation, and the dormant shared PR lifecycle boundary. | Native Android verification operations | High | 2026-08-27 |
| `agent-docs/operations/verification-and-runtime.md` | Verification ownership by delivery path, including focused local proof, immutable exact-base/exact-synthetic-merge docs-drift CI comparisons, deliberate near-merge Ready admission, broad exact-head PR CI, protected-main live Junction proof, fail-closed tag-release matrices, staggered six-hour native iOS and Android production canaries with successful-SHA checkpoint admission and explicit-rerun recovery, claim-based rendered evidence, canonical command and executor semantics, runtime proof boundaries, and package/app testing surfaces. | Verification policy | High | 2026-08-27 |
