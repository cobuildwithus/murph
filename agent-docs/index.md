...
| `agent-docs/product-specs/habitat.md` | Habitat facts, Environment grading, native report projection and SwiftUI voice audit bridge. | Habitat product spec | High | 2026-09-06 |
