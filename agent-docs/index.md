...
| `agent-docs/product-specs/journal.md` | Private timelines, connected plans, and morning reminder reconciliation with or without connected accounts. | Journal product spec | High | 2026-09-23 |
