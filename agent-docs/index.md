...
| `agent-docs/exec-plans/active/2026-09-23-gpt6-defaults.md` | GPT-6 managed inference defaults and focused model-selection proof. | Active execution plan | Medium | 2026-09-23 |
