...
| `agent-docs/references/hosted-postgres-runtime.md` | Postgres execution authority, mixed member routing, atomic new-member route creation, native completion, managed uploads, deletion-safe handoff, empty-object accounting, and rolling migration readiness. | Hosted runtime ownership | High | 2026-09-15 |
