...
| `agent-docs/SECURITY.md` | Security constraints, trust boundaries, and escalation rules. | Auth/secrets/data boundaries/process | Healthy Bob Maintainer | Per security-affecting change | High | 2026-03-23 |
