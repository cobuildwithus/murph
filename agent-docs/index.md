...
| `agent-docs/exec-plans/active/` | Active execution plans and in-flight coordination docs. | Plan workflow | Healthy Bob Maintainer | Per process change | Medium | 2026-03-22 |
