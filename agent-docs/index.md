...
| `agent-docs/exec-plans/active/` | Task-owned in-flight execution plans, including the current fifth managed ReviewGPT browser-lane rollout. | Active plan lifecycle | Medium | 2026-08-15 |
