...
| `agent-docs/operations/pr-reviewgpt-loop.md` | PR review for realistic serious bugs and material Complexity Collapse, with a three-round review cap and no base-update limit. | Final PR ReviewGPT loop | Medium | 2026-09-04 |
