...
| `agent-docs/product-specs/imessage-workout-tracking.md` | iMessage workout product spec, chat-only routine access, and verified editor requirement for new workout-card attachment. | iMessage workout product spec | High | 2026-09-08 |
