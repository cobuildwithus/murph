...
| `agent-docs/exec-plans/active/` | Task-owned in-flight execution plans, including current phone-call status remediation and the fifth managed ReviewGPT browser-lane rollout. | Active plan lifecycle | Medium | 2026-08-15 |
