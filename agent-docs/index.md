...
| `agent-docs/exec-plans/active/2026-09-22-poll-result-wake.md` | Automatic native poll result context and one-shot conversation notification; current contract is owned by `ARCHITECTURE.md`. | Active implementation plan | Medium | 2026-09-22 |
