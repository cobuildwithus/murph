...
| `agent-docs/operations/completion-workflow.md` | Parent-owned completion evidence and final ReviewGPT eligibility; specialist passes are retired. | Completion workflow | High | 2026-09-11 |
