...
| `ARCHITECTURE.md` | Current runtime architecture, including hosted media identity, reference-only preservation, current v2 checkpoint cleanup and receipt recovery. | Current runtime architecture | High | 2026-09-10 |
