...
16. Close any active execution plan and use the commit path chosen by the routing doc and `AGENTS.md` before handoff. Do not treat the commit as a substitute for any still-required audit pass.
