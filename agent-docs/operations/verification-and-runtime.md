...
frame/form counts, positive and negative action counts classified through
Playwright's computed accessible names, whether positive actions are hidden,
...
credentials, or member data. A real sign-in
