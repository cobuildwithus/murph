...
- Legacy bare personal routes are upgraded only after a fresh direct-home route confirms personal runtime scope and at least two live built-in personal automations uniquely anchor their shared target. The canonical registry revalidates every route and status under one lock before writing. Archived routes, group runtimes, single mutable anchors, concurrent edits, and ambiguous targets stay unchanged.
