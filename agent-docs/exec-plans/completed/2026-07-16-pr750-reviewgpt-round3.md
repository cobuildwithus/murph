...
- Final `main` reconciliation — merged `92c05525de71a3868d965b81b2e864cf884539c6` additively, retaining both disclosure and Labs architecture/security/testing-index entries. Post-merge verification passed: assistant-runtime 75 files / 1,732 tests with 2 skipped; focused runtime 2 files / 196 tests; focused assistant-engine 2 files / 88 tests; hosted-execution 37 files / 367 tests; operator-config 25 files / 195 tests; focused Web disclosure/egress 2 files / 61 tests; focused Web retention/disclosure 3 files / 43 tests with the opt-in database case skipped; Cloudflare runner-platform 1 file / 133 tests; all affected package, Cloudflare, and Web typechecks; docs gardening; and `git diff --check`. The isolated real-PostgreSQL retention proof also passed again after the merge with 1 test.
