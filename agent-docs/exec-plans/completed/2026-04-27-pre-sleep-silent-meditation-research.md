...
- Cleanup/dedupe audit: no duplicate PMID, DOI, or URL identities across `packages/health-commons/content/sources/pre-sleep-downshift-practices`; pre-sleep source references have zero missing global source keys after the `source_artifact:pmid-36016077` YAML quoting fix.
Status: completed
Updated: 2026-04-28
