...
- Keep the worker-created completed snapshot immutable and finish this still-active lane under a follow-up active-plan path so the real closure can happen cleanly.
