...
Complete; closing by user acceptance.
...
- Related code landed in prior commits, including hosted device connect completion flow and Junction callback source-row persistence.
