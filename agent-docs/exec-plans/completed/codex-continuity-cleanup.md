...
## 22. Remove legacy hosted repair from the hot path

Implementation found an active legacy hosted repair helper for old Murph-owned Codex continuity snapshots. Remove that hot-path repair code with this migration instead of carrying a second continuity system beside canonical `codexResume`.
