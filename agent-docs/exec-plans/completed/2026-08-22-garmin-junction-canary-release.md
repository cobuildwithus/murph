...
- [x] Resolve the final cross-cutting ReviewGPT gate.
- [x] Confirm required GitHub checks and current-base merge-tree proof.
- [x] Perform the parent final diff and privacy review.
