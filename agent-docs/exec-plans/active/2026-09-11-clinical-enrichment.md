...
- Developer friction: the existing Frog entry for dropped Vitest filters already covers package-script argument forwarding. Focused checks use direct Vitest entrypoints; no duplicate entry was created.
