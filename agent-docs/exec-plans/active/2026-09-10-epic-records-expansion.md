...
- The feature owner confirmed no clinical records have been imported and the feature is not live. The old-importer migration premise in #3172 review rounds 1 and 2 is inapplicable. Remove the added hold-promotion callback, retained-source verifier and migration-only tests; preserve ordinary revision/conflict behavior. Review the simpler initial-launch importer in round 3.
- #3200 contains source-history mapping and its passing live assistant journey; #3203 contains four additional provider query variants. Authorized linked-document reads and durable large-chart continuation remain pending. Current scope is to make the four existing PRs green and merge-ready.

- Initial-import review found two actual gaps: Fahrenheit aliases reached summaries without conversion, and history note JSON key order affected source-revision equality. Fix these at the existing conversion/serialization owners, with canonical-to-projection and duplicate/conflict regressions. The user authorized continued remediation and review, including a fourth measurement review; no old-importer migration or production rollout is in scope.
