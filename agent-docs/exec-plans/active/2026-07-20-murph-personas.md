...
- Missing persona resolves to Classic Murph, preserving existing users and current technical preferences.
...
2. Effective style resolves as explicit override -> persona default -> Classic default.
