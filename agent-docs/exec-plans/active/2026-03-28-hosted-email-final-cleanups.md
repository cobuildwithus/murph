...
Tighten the hosted Cloudflare email bridge without redesigning it by fixing parser drift, self-alias handling, bootstrap channel gating, and hosted-only delivery scope.
