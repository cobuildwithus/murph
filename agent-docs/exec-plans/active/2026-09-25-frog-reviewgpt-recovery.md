...
- The long-prompt editor report #2945 remains outside this fix: bounded canonical draft trials could not start because the managed profiles were already open without CDP. Native synthetic control success does not establish actual-editor recovery.
...
- Canonical local tooling verification, final exact-head ReviewGPT, and CI remain pending.
