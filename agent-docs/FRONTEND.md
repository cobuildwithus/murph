...
Colors and fonts are mapped to standard shadcn CSS variables in `apps/web/app/globals.css`. Component showcase at [localhost:3000/design-system](http://localhost:3000/design-system) when running dev server.
...
- When creating a new shared component, add it to the `/design-system` showcase page at [localhost:3000/design-system](http://localhost:3000/design-system).
