...
- The browser legal-consent route may accept an invite code only as an explicit
  ...
  ownership, suspension, messaging readiness, and billing eligibility before
  activation. A client-supplied invite code or a Privy authentication webhook
  is never independent enrollment authority.
