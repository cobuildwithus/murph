...
- canonical source envelope and attachment evidence is persisted under `raw/inbox/<source>/...`; image attachment bytes are normalized to bounded static WebP before storage or left unstored, and canonical raw metadata drops size-like provider fields instead of retaining original byte sizes
