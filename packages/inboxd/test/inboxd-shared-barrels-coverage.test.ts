...
test("shared-runtime helpers cover sensitive redaction and abort fast paths", async () => {
  ...
  const sanitized = sanitizeRawMetadata({
    ...
    nested: {
      ...
      privateDarwinPath: "/private/var/folders/zz/abcd1234/T/inbox-attachment",
      darwinPath: "/var/folders/zz/abcd1234/T/inbox-attachment",
  ...
  assert.deepEqual(sanitized, {
    ...
    nested: {
      ...
      privateDarwinPath: "<REDACTED_PATH>",
      darwinPath: "<REDACTED_PATH>",
      bytes: "<3 bytes>",
      bigintValue: "42",
