...
export interface HostedExecutionDeviceSyncAccountActionRequest {
  action: "reconcile";
  connectionId: string;
}

export interface HostedExecutionDeviceSyncAccountActionResponse {
  action: "reconcile";
  connectionId: string;
  occurredAt: string;
  status: "queued";
...
export function parseHostedExecutionDeviceSyncAccountActionRequest(
  ...
  if (action !== "reconcile") {
    throw new TypeError("Hosted device-sync account action request action must be reconcile.");
  }
  return {
    action,
...
export function parseHostedExecutionDeviceSyncAccountActionResponse(
  ...
  if (action !== "reconcile") {
    throw new TypeError("Hosted device-sync account action response action must be reconcile.");
  }
  ...
  if (status !== "queued") {
    throw new TypeError("Hosted device-sync account action response status must be queued.");
  }
  return {
    action,
    connectionId: requireString(
