...
- provide typed fetch clients for signed dispatch requests and generic bearer-authenticated
...
- this package owns the hosted-execution transport seam; app-local auth adapters
  still own deployment-specific bearer token acquisition and verification
