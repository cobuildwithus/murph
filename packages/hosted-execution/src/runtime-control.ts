...
export const HOSTED_CANONICAL_WRITE_REPAIR_STATUS_KEY =
  "hostedCanonicalWriteRepairStatus";
export const HOSTED_CANONICAL_WRITE_REPAIR_LOG_SHA_STATUS_KEY =
  "hostedCanonicalWriteRepairLogSha256";
export const HOSTED_CANONICAL_WRITE_REPAIR_LOG_BYTE_SIZE_STATUS_KEY =
  "hostedCanonicalWriteRepairLogByteSize";
