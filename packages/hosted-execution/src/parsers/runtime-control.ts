...
function parseHostedRuntimeLatencyPhaseBreakdown(
  ...
  if (record.orchestration !== undefined) {
    ...
    breakdown.orchestration = {
      ...
      ...requireOptionalNonNegativeInteger(orchestration, "shellPrewarmLastHintAtEpochMs", orchestrationLabel),
      ...requireOptionalNonNegativeInteger(orchestration, "shellPrewarmLastFinishedAtEpochMs", orchestrationLabel),
      ...requireOptionalNonNegativeInteger(orchestration, "shellPrewarmLastOperationElapsedMs", orchestrationLabel),
      ...requireOptionalNonNegativeInteger(orchestration, "shellPrewarmHintCount", orchestrationLabel),
      ...requireOptionalNonNegativeInteger(orchestration, "shellPrewarmStartIssuedCount", orchestrationLabel),
      ...requireOptionalNonNegativeInteger(orchestration, "shellPrewarmSupersededCount", orchestrationLabel),
      ...requireOptionalNonNegativeInteger(orchestration, "shellPrewarmFailedCount", orchestrationLabel),
      ...requireOptionalNonNegativeInteger(orchestration, "shellPrewarmColdStartObservedCount", orchestrationLabel),
