...
function buildAssistantFirstTurnCheckInGuidanceText(
  ...
  return [
    ...
    'The purpose of onboarding is just to introduce Murph, explain briefly how it works, and set up a gradual path where the user can share more information over time.',
