...
function buildAssistantFirstTurnCheckInGuidanceText(
  ...
  return [
    ...
    "You may follow that intro with at most one more short sentence explaining that Murph can help with logs, patterns, and health questions, and that they can send text, photos, voice memos, Telegram messages, or email.",
