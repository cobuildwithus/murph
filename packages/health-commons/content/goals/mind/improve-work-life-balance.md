...
key: goal_template:improve-work-life-balance
slug: improve-work-life-balance
title: Improve My Work-Life Balance
summary: Make work fit inside a life that still has enough time and energy for health, relationships, responsibilities, and rest.
status: field-testing
quality: usable
aliases:
  - create better work-life balance
  - work less outside work
categories:
  - goals
  - mind
  - work-life
goal:
  ...
  goalPhrase: improve my work-life balance
  successSignals:
    - id: planned_stop_time
      kind: behavior
      label: More workdays end near the planned time
    - id: protected_life_time
      kind: behavior
      label: Important personal time survives most weeks
    - id: recovery_capacity
      kind: function
      label: Enough energy remains for life outside work
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      ...
      - energy-fatigue
  startPrompt: Hey Murph, help me improve my work-life balance.
  indexable: true
safety:
  cautionLevel: low
---
