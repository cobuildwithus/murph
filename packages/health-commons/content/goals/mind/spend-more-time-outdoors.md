...
key: goal_template:spend-more-time-outdoors
slug: spend-more-time-outdoors
title: Spend More Time Outdoors
summary: Build regular outdoor time into daily life for movement, daylight, recovery, and contact with nature.
...
goal:
  ...
  goalPhrase: spend more time outdoors
  successSignals:
    - id: outdoor_days
      kind: behavior
      label: More days include intentional outdoor time
    - id: outdoor_minutes
      kind: behavior
      label: Weekly outdoor time increases sustainably
    - id: restored_state
      kind: symptom
      label: More outdoor sessions leave me steadier or more energized
  evidenceSourceKeys:
  ...
  startPrompt: Hey Murph, help me spend more time outdoors.
  indexable: true
safety:
  cautionLevel: low
---
