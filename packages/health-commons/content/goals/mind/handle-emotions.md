...
key: goal_template:handle-emotions
slug: handle-emotions
title: Handle My Emotions Better
summary: Notice emotions earlier, understand what they are signaling, and choose responses that fit the situation and your values.
...
goal:
  ...
  goalPhrase: handle my emotions better
  successSignals:
    - id: emotion_awareness
      kind: function
      label: I notice and name emotions earlier
    - id: chosen_response
      kind: behavior
      label: More responses reflect what I actually want to do
    - id: recovery_time
      kind: function
      label: Less time needed to recover after intense emotions
  evidenceSourceKeys:
  ...
  startPrompt: Hey Murph, help me handle my emotions better.
  indexable: true
safety:
  cautionLevel: low
---
