...
key: goal_template:manage-anxiety
slug: manage-anxiety
title: Manage Anxiety
summary: Build a practical routine that makes anxious thoughts and body sensations less disruptive to everyday life.
...
goal:
  category: mind
  outcomeKind: symptom
  goalPhrase: manage my anxiety
  successSignals:
    - id: anxiety_interference
      kind: symptom
      label: Anxiety interferes less with ordinary life
    - id: valued_actions
      kind: behavior
      label: More important activities completed despite anxiety
    - id: recovery_time
      kind: function
      label: A faster return to baseline after anxious moments
  evidenceSourceKeys:
  ...
  startPrompt: Hey Murph, help me manage my anxiety.
  indexable: true
safety:
...
This page supports everyday self-management; it does not diagnose or replace treatment. Seek urgent local help if anxiety comes with thoughts of self-harm, an inability to stay safe, severe chest pain, fainting, or another possible medical emergency.
