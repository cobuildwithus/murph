...
key: goal_template:get-in-basketball-shape
slug: get-in-basketball-shape
title: Get in Basketball Shape
summary: Build the repeat-sprint fitness, movement durability, and skill-specific conditioning to play hard without fading early.
...
goal:
  ...
  goalPhrase: get in basketball shape
  successSignals:
  ...
  workflow:
    ...
    ownerSkillIds:
      - running-cardio
      - strength-training
  startPrompt: Hey Murph, help me get in basketball shape.
  indexable: true
safety:
...
Warm up before high-speed cutting and jumping. Stop for chest pain, fainting, severe unusual breathlessness, or lower-limb pain or instability that makes landings unsafe.
