...
key: goal_template:ride-100-miles
slug: ride-100-miles
title: Ride 100 Miles
summary: Prepare for a century ride with progressive time in the saddle, practiced fueling, bike comfort, pacing, and event logistics.
...
goal:
  category: cardio
  outcomeKind: event
  goalPhrase: ride 100 miles
  successSignals:
    - id: durable_weekly_riding
      kind: behavior
      label: Consistent weekly riding with one progressive long ride
    - id: long_ride_fueling_and_comfort
      kind: capacity
      label: Long rides completed with workable fueling and bike comfort
    - id: century_finish
      kind: milestone
      label: A controlled 100-mile finish
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      ...
      - running-cardio
  startPrompt: Hey Murph, help me ride 100 miles.
  indexable: true
safety:
