...
key: goal_template:climb-stairs-without-getting-winded
slug: climb-stairs-without-getting-winded
title: Climb Stairs Without Getting Winded
summary: Build the leg strength, pacing, and aerobic capacity to handle everyday stairs with calmer breathing.
status: field-testing
quality: usable
aliases:
  - get better at climbing stairs
...
goal:
  ...
  goalPhrase: climb stairs without getting winded
  successSignals:
    - id: comfortable_flights
      kind: function
      label: More flights climbed with controlled breathing
    - id: faster_breathing_settle
      kind: function
      label: Breathing settles sooner at the top
    - id: stair_practice_days
      kind: behavior
      label: Regular stair or hill practice
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - running-cardio
      - strength-training
  startPrompt: Hey Murph, help me climb stairs without getting winded.
  indexable: true
safety:
