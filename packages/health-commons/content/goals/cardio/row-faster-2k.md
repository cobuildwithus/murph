...
key: goal_template:row-faster-2k
slug: row-faster-2k
title: Row 2,000 Meters Faster
summary: Improve a 2K rowing time with better pacing, efficient technique, aerobic support, and focused race-pace intervals.
status: field-testing
quality: usable
aliases:
  - improve my 2K row time
  - get faster on the rowing machine
categories:
  - goals
  - cardio
  - rowing
...
goal:
  ...
  goalPhrase: row 2,000 meters faster
  successSignals:
    - id: two_kilometer_time
      kind: milestone
      label: A faster well-paced 2,000-meter row
    - id: repeat_split_consistency
      kind: capacity
      label: More even splits across race-pace intervals
    - id: technical_efficiency
      kind: function
      label: Efficient technique maintained under fatigue
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      ...
      - running-cardio
      - strength-training
  startPrompt: Hey Murph, help me row 2,000 meters faster.
  indexable: true
safety:
