...
quality: usable
aliases:
  - strengthen my core postpartum
  - recover abdominal strength after birth
categories:
  - goals
  - life-stages
  - postpartum
...
goal:
  ...
  goalPhrase: rebuild core strength after birth
  successSignals:
    - id: pressure-control-improves
      kind: capacity
      label: Breathing and trunk tension coordinate during movement
    - id: daily-tasks-easier
      kind: function
      label: Rolling, rising, lifting, carrying, and walking feel easier
    - id: progressive-core-loading
      kind: behavior
  ...
  workflow:
    ...
    ownerSkillIds:
      - physical-therapy
      - strength-training
  startPrompt: Hey Murph, help me rebuild core strength after birth.
  indexable: true
safety:
