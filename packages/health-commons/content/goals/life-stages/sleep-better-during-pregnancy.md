...
quality: usable
aliases:
  - get better sleep while pregnant
  - improve prenatal sleep
categories:
  - goals
  - life-stages
  - pregnancy
...
goal:
  ...
  goalPhrase: sleep better during pregnancy
  successSignals:
    - id: easier-sleep
      kind: function
      label: Falling asleep or returning to sleep is easier
    - id: fewer-disruptions
      kind: symptom
      label: Comfort, reflux, leg, and bathroom disruptions are reduced
    - id: better-daytime-function
      kind: function
      label: Daytime energy and attention improve
  evidenceSourceKeys:
  ...
  startPrompt: Hey Murph, help me sleep better during pregnancy.
  indexable: true
safety:
  cautionLevel: moderate
  avoidOrGetClinicianGuidance:
    - Check any sleep medicine, antihistamine, melatonin, herb, or supplement with the pregnancy care team rather than assuming over-the-counter means pregnancy-safe.
  notes:
...
- [ACOG: Can I Sleep on My Back When Pregnant?](https://www.acog.org/womens-health/experts-and-stories/ask-acog/can-i-sleep-on-my-back-when-im-pregnant)
- [Meta-analysis of CBT for Insomnia During Pregnancy](https://pubmed.ncbi.nlm.nih.gov/36529887/)
