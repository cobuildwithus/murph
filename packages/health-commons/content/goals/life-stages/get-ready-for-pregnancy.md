...
aliases:
  ...
  - improve my preconception health
categories:
  - goals
  - life-stages
  - preconception
goal:
  ...
  goalPhrase: get ready for pregnancy
  successSignals:
    - id: folic-acid-routine
      kind: behavior
      label: Daily folic acid is in place before conception
    - id: health-plan-reviewed
      kind: milestone
      label: Medicines, conditions, vaccines, and family history are reviewed
    - id: sustainable-health-foundation
      kind: behavior
  ...
  workflow:
    ...
    ownerSkillIds:
      ...
      - nutrition-strategy
  startPrompt: Hey Murph, help me get ready for pregnancy.
  indexable: true
safety:
  cautionLevel: moderate
  avoidOrGetClinicianGuidance:
    - Review prescription medicines, over-the-counter medicines, and supplements before changing or stopping them; abrupt discontinuation can also be harmful.
  notes:
...
- [CDC: Planning for Pregnancy](https://www.cdc.gov/pregnancy/about/index.html)
