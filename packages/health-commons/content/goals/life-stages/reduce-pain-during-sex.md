...
goal:
  ...
  successSignals:
    - id: lower-sexual-pain
      kind: symptom
      label: Less pain, burning, or guarding during wanted sexual activity
    - id: more-comfortable-options
      kind: function
      label: More comfortable and enjoyable forms of intimacy
    - id: cause-addressed
      kind: milestone
...
safety:
  ...
  avoidOrGetClinicianGuidance:
    - Do not repeatedly push through pain or use numbing products to override the body's warning signal without guidance.
  stopIf:
...
- [ACOG: Your Sexual Health](https://www.acog.org/womens-health/faqs/your-sexual-health)
