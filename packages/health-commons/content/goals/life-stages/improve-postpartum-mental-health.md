...
summary: Support postpartum mood and anxiety with early treatment, practical help, protected recovery, social connection, and a plan for difficult moments.
...
Postpartum depression and anxiety are health conditions, not evidence that you are ungrateful or failing. Improvement often requires **professional treatment plus practical relief from sleep loss, isolation, pain, feeding strain, and impossible workload**. Therapy and medication can be effective. Small daily supports help, but they should not be used to delay care when symptoms interfere with life.

## What to do

- **Tell one person today.** Use direct words: “My mood or anxiety is not okay, and I need help.” Ask that person to stay involved until a professional contact is made.
- **Contact the obstetric, primary-care, or mental-health team early.** Do not wait for a routine postpartum visit. Describe sleep, anxiety, sadness, irritability, intrusive thoughts, appetite, function, and any prior depression, anxiety, bipolar disorder, psychosis, or trauma.
- **Make treatment concrete.** Psychotherapy, support groups, and medications are valid options. Medication decisions can account for breastfeeding, prior response, side effects, and the risks of untreated illness.
- **Protect one block of rest.** Arrange a partner, family member, friend, postpartum helper, or feeding plan that creates the longest feasible protected sleep opportunity. Sleep alone is not treatment for depression, but severe sleep loss can intensify symptoms.
- **Reduce the daily load.** Choose a minimum day: eat, drink, take medicine, shower or change clothes, get five minutes of daylight, and communicate with one supportive person. Delay optional chores.
- **Use movement as support, not a prescription.** A short walk or gentle postpartum activity can help mood and recovery when physically appropriate. It is an addition to care, not proof that you should be able to exercise your way out of depression.
- **Make frightening thoughts discussable.** Unwanted intrusive thoughts can occur with postpartum anxiety or OCD and do not automatically mean intent. A clinician can distinguish them from psychosis and help reduce shame and risk.
- **Create an emergency plan.** Write who will take the baby, who will stay with you, which number to call, and where to go if safety changes.
...
Look for more moments of relief, less dread or panic, improved ability to eat and rest, fewer hours consumed by rumination, greater connection, and confidence that help is available. Treatment response may take time and may require adjustment. Bonding with the baby can also develop gradually; immediate bliss is not a requirement.

## If you get stuck

If the advice is only “sleep when the baby sleeps,” name the practical barriers and ask for treatment. Feeding pain, infant medical needs, relationship conflict, financial stress, trauma, and lack of childcare may require their own support. If a medicine helped before, tell the clinician. If a medicine causes concerning side effects or does not help, contact the prescriber rather than stopping abruptly.
