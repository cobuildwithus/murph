...
quality: usable
aliases:
  - reduce vaginal dryness after menopause
  - improve menopause vaginal symptoms
categories:
  - goals
  - life-stages
  - menopause
...
goal:
  ...
  parentGoalKey: goal_template:reduce-pain-during-sex
  outcomeKind: symptom
  goalPhrase: improve vaginal comfort after menopause
  successSignals:
    - id: less-dryness-and-irritation
      kind: symptom
      label: Less dryness, burning, itching, or irritation
    - id: more-comfortable-sex
      kind: function
      label: Sexual activity is more comfortable when wanted
    - id: urinary-symptoms-improved
      kind: symptom
      label: Associated urinary irritation or urgency is improved
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      ...
      - physical-therapy
  startPrompt: Hey Murph, help me improve vaginal comfort after menopause.
  indexable: true
safety:
...
Bleeding after menopause should be evaluated. Seek care for a new sore, lump, unusual discharge, repeated urinary infections, or symptoms that persist despite a sensible first plan.
...
- [The Menopause Society: Genitourinary Syndrome of Menopause (2025 PDF)](https://menopause.org/wp-content/uploads/for-women/MenoNote-GSM.pdf)
