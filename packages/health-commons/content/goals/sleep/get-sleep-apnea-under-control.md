...
- Use the prescribed treatment consistently. Positive airway pressure (PAP) is a common first-line option; fitted oral appliances, positional therapy, weight management, surgery, or other approaches may be appropriate in selected cases.
...
Start with a clear baseline: diagnosis date, apnea-hypopnea index (AHI, the average number of breathing events per hour) from the study, oxygen findings, main symptoms, blood pressure if relevant, and the treatment recommendation. Write the next appointment or equipment step on the calendar.
...
Bring the machine or app report and a short symptom summary to follow-up. Ask whether breathing events that remain, pauses that arise during treatment, mask leak, or pressure settings need adjustment. If the first treatment is intolerable, discuss alternatives rather than abandoning care silently.

## How to know it is working

Effective control combines objective and lived outcomes: treatment is used through most of the sleep period, breathing events that remain are acceptably controlled for your clinical situation, oxygen is no longer repeatedly dropping, and symptoms such as gasping, morning headaches, waking to urinate, or daytime sleepiness improve.
