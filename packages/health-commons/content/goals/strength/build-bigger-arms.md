...
key: goal_template:build-bigger-arms
slug: build-bigger-arms
title: Build Bigger Arms
summary: Grow your biceps and triceps with direct work, progressive training, and enough recovery.
...
goal:
  ...
  goalPhrase: build bigger arms
  successSignals:
    - id: weekly_arm_training
      kind: behavior
      label: Biceps and triceps receive consistent weekly work
    - id: arm_exercise_progress
      kind: capacity
      label: Curl and extension performance improves
    - id: arm_size_trend
      kind: function
      label: Arm measurements or standardized photos gradually change
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - strength-training
      - nutrition-strategy
  startPrompt: Hey Murph, help me build bigger arms.
  indexable: true
safety:
  cautionLevel: low
---
