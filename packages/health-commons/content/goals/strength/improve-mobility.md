...
key: goal_template:improve-mobility
slug: improve-mobility
title: Improve My Mobility
summary: Build the usable range of motion needed for the movements and activities that matter to you.
...
goal:
  ...
  goalPhrase: improve my mobility
  successSignals:
    - id: mobility_practice
      kind: behavior
      label: Relevant mobility work happens consistently
    - id: usable_range_of_motion
      kind: capacity
      label: Target movements gain comfortable controlled range
    - id: easier_meaningful_movement
      kind: function
      label: Daily or sport movements feel less restricted
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - mobility-posture
      - strength-training
  startPrompt: Hey Murph, help me improve my mobility.
  indexable: true
safety:
  cautionLevel: low
---
