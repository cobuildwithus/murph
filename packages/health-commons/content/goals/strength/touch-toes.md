...
key: goal_template:touch-toes
slug: touch-toes
title: Touch My Toes
summary: Improve forward-bend reach with consistent hamstring work, hip control, and gradual practice.
...
goal:
  category: strength
  parentGoalKey: goal_template:improve-mobility
  outcomeKind: skill
  goalPhrase: touch my toes
  successSignals:
    - id: toe_touch_practice
      kind: behavior
      label: Forward-fold mobility is practiced consistently
    - id: forward_reach_range
      kind: capacity
      label: Fingertip-to-floor distance gradually decreases
    - id: toe_touch_milestone
      kind: milestone
      label: Toes are reached with a controlled forward bend
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - mobility-posture
      - strength-training
  startPrompt: Hey Murph, help me touch my toes.
  indexable: true
safety:
  cautionLevel: low
---
