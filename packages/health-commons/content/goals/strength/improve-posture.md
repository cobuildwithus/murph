...
key: goal_template:improve-posture
slug: improve-posture
title: Improve My Posture
summary: Build comfortable, adaptable positions with strength, movement variety, and a workspace that fits.
...
goal:
  ...
  goalPhrase: improve my posture
  successSignals:
    - id: posture_breaks
      kind: behavior
      label: Long periods in one position are broken up
    - id: postural_endurance
      kind: capacity
      label: Desired sitting and standing positions feel easier to hold
    - id: posture_comfort
      kind: function
      label: Work, walking, and lifting feel more comfortable
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - mobility-posture
      - strength-training
  startPrompt: Hey Murph, help me improve my posture.
  indexable: true
safety:
  cautionLevel: low
---
