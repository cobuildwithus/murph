...
key: goal_template:jump-higher
slug: jump-higher
title: Jump Higher
summary: Improve vertical jump with strength, power, landing skill, and a manageable amount of jumping.
...
goal:
  ...
  goalPhrase: jump higher
  successSignals:
    - id: jump_training_sessions
      kind: behavior
      label: Strength and jump practice happen consistently
    - id: lower_body_power
      kind: capacity
      label: Explosive strength and takeoff quality improve
    - id: vertical_jump_height
      kind: milestone
  ...
  startPrompt: Hey Murph, help me jump higher.
  indexable: true
safety:
