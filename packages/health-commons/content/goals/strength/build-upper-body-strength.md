...
key: goal_template:build-upper-body-strength
slug: build-upper-body-strength
title: Build Upper-Body Strength
summary: Build balanced pushing, pulling, carrying, and overhead strength with a repeatable weekly plan.
...
goal:
  ...
  goalPhrase: build my upper-body strength
  successSignals:
    - id: upper_body_sessions
      kind: behavior
      label: Two or more useful upper-body sessions most weeks
    - id: push_pull_progress
      kind: capacity
      label: Pushing and pulling exercises improve over time
    - id: upper_body_function
      kind: function
      label: Carrying, lifting, and reaching tasks feel easier
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - strength-training
  startPrompt: Hey Murph, help me build my upper-body strength.
  indexable: true
safety:
  cautionLevel: low
---
