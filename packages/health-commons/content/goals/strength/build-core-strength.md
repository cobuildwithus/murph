...
key: goal_template:build-core-strength
slug: build-core-strength
title: Build Core Strength
summary: Build a trunk that can brace, carry, rotate, and transfer force without endless crunches.
...
goal:
  ...
  goalPhrase: build my core strength
  successSignals:
    - id: core_training_sessions
      kind: behavior
      label: Trunk work is trained consistently each week
    - id: core_exercise_progress
      kind: capacity
      label: Bracing, carrying, or controlled trunk exercises improve
    - id: better_force_transfer
      kind: function
      label: Lifting and daily movement feel more stable
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - strength-training
  startPrompt: Hey Murph, help me build my core strength.
  indexable: true
safety:
  cautionLevel: low
---
