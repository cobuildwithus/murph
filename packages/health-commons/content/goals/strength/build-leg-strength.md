...
key: goal_template:build-leg-strength
slug: build-leg-strength
title: Build Leg Strength
summary: Build stronger hips, knees, and ankles for lifting, stairs, sport, and everyday movement.
...
goal:
  ...
  goalPhrase: build my leg strength
  successSignals:
    - id: lower_body_sessions
      kind: behavior
      label: Lower-body movements are trained consistently
    - id: leg_exercise_progress
      kind: capacity
      label: Squat, hinge, step, or calf work improves
    - id: easier_lower_body_tasks
      kind: function
      label: Stairs, hills, lifting, and standing feel easier
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - strength-training
  startPrompt: Hey Murph, help me build my leg strength.
  indexable: true
safety:
  cautionLevel: low
---
