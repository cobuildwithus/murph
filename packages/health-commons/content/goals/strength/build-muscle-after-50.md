...
goal:
  ...
  goalPhrase: build muscle after 50
  successSignals:
    - id: consistent_resistance_training
      kind: behavior
      label: Resistance training happens at least twice most weeks
    - id: strength_and_function_progress
      kind: capacity
      label: Strength and physical function improve
    - id: muscle_trend
      kind: function
  ...
  workflow:
    ...
    ownerSkillIds:
      - strength-training
      - nutrition-strategy
  startPrompt: Hey Murph, help me build muscle after 50.
  indexable: true
safety:
  cautionLevel: low
---
