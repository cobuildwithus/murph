...
key: goal_template:do-first-push-up
slug: do-first-push-up
title: Do My First Push-Up
summary: Progress from a manageable incline to one controlled floor push-up.
status: field-testing
quality: usable
aliases:
  - get my first push-up
categories:
  - goals
  - strength
  - bodyweight-skills
goal:
  ...
  outcomeKind: skill
  goalPhrase: do my first push-up
  successSignals:
    - id: push_up_practice
      kind: behavior
      label: Push-up practice happens two or three times per week
    - id: lower_incline_progress
      kind: capacity
      label: Controlled repetitions are possible at a lower incline
    - id: first_floor_push_up
      kind: milestone
      label: One full floor push-up is completed with control
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - strength-training
  startPrompt: Hey Murph, help me do my first push-up.
  indexable: true
safety:
  cautionLevel: low
---
