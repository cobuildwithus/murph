...
key: goal_template:build-stronger-glutes
slug: build-stronger-glutes
title: Build Stronger Glutes
summary: Strengthen your glutes with squats, hinges, hip extension, and single-leg work that progresses.
...
goal:
  category: strength
  parentGoalKey: goal_template:build-muscle
  outcomeKind: capacity
  goalPhrase: build stronger glutes
  successSignals:
    - id: glute_training_sessions
      kind: behavior
      label: Glutes are trained consistently across the week
    - id: hip_strength_progress
      kind: capacity
      label: Hip extension and single-leg exercises improve
    - id: lower_body_function
      kind: function
      label: Hills, stairs, lifting, or sport movement feels stronger
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - strength-training
  startPrompt: Hey Murph, help me build stronger glutes.
  indexable: true
safety:
  cautionLevel: low
---
