...
key: goal_template:overhead-press-more-weight
slug: overhead-press-more-weight
title: Overhead Press More Weight
summary: Build a stronger overhead press with repeatable practice, balanced upper-body work, and small progressions.
status: field-testing
quality: usable
aliases:
  - increase my overhead press
categories:
  - goals
  - strength
  - lifting
goal:
  ...
  goalPhrase: overhead press more weight
  successSignals:
    - id: overhead_press_practice
      kind: behavior
      label: The overhead press is practiced consistently
    - id: overhead_press_load
      kind: capacity
      label: More load or repetitions with the same press standard
    - id: stable_overhead_control
      kind: function
      label: Overhead lifting feels controlled and repeatable
  evidenceSourceKeys:
  ...
  workflow:
    ...
    ownerSkillIds:
      - strength-training
  startPrompt: Hey Murph, help me overhead press more weight.
  indexable: true
safety:
  cautionLevel: low
---
