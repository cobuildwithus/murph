...
summary: 'Merged 1 candidate row(s) from shard(s): differential-diagnosis-safety. Use for differential diagnosis, escalation, imaging, or red-flag routing rather than protocol efficacy. Older primary-care review likely useful for clinical presentation and primary-care differential framing.'
status: draft
quality: usable
aliases:
- pmid-15864895
...
source:
  kind: review
  title: 'Iliotibial band syndrome: a common source of knee pain'
  authors: Razib Khaund, Sharon H. Flynn
