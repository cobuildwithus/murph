...
source:
  kind: review
  title: Chronic leg pain in athletes
  authors: "M. Tyrrell Burrus, Brian C. Werner, Jim S. Starman, F. Winston Gwathmey, et al."
...
researchEvidence:
  ...
  - 'Reducer priority: low; claim-use label: safety-only; directness label: safety_boundary.'
