...
summary: 'Merged 1 candidate row(s) from shard(s): cycling-specific-itbs. Cyclist-specific or bike-fit context; keep separate from runner return-to-run claims. Orthopedic cycling lower-extremity injury review; may include knee overuse and fit factors relevant to ITBS boundaries.'
status: draft
quality: usable
aliases:
- pmid-18063715
...
source:
  kind: review
  title: Cycling injuries of the lower extremity
  authors: Tony Wanich, Christopher Hodgkins, Jean-Allain Columbier, et al.
