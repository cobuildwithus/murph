...
summary: 'Merged 1 candidate row(s) from shard(s): differential-diagnosis-safety. Use for differential diagnosis, escalation, imaging, or red-flag routing rather than protocol efficacy. Open imaging review helps define when imaging may clarify ITBS or exclude alternate lateral knee pathology.'
status: draft
quality: usable
aliases:
- pmid-32514741
