...
- type: cites
  target: source_artifact:pmid-29552271
- type: cites
  target: source_artifact:pmid-35333214
- type: cites
  target: source_artifact:doi-10.5318-wjo.v4.i1.1
- type: cites
  target: source_artifact:pmid-20410914
- type: cites
  target: source_artifact:pmid-24888214
- type: cites
  target: source_artifact:pmid-26121474
- type: cites
  target: source_artifact:pmid-32289393
- type: cites
  target: source_artifact:pmid-33640508
- type: cites
  target: source_artifact:pmid-33640513
- type: cites
  target: source_artifact:pmid-30227084
- type: cites
  target: source_artifact:pmid-39899363
- type: cites
  target: source_artifact:pmid-40650752
- type: cites
...
- type: cites
  target: source_artifact:pmid-21879777
- type: cites
  target: source_artifact:pmid-3530309
- type: cites
  target: source_artifact:pmid-19438994
- type: cites
  target: source_artifact:pmid-25192842
- type: cites
...
- type: cites
  target: source_artifact:pmid-16581685
- type: cites
  target: source_artifact:doi-10.1016-j.mla.2006.06.001
- type: cites
  target: source_artifact:pmid-18254808
- type: cites
  target: source_artifact:pmid-19397672
- type: cites
  target: source_artifact:pmid-23551853
- type: cites
  target: source_artifact:pmid-30074109
- type: cites
  target: source_artifact:pmid-25266806
- type: cites
  target: source_artifact:clinicaltrials-nct07054710-cosmetic-light-mask-2026-04-24
- type: cites
...
- type: cites
  target: source_artifact:pmid-29552272
- type: cites
...
- type: cites
  target: source_artifact:pmid-33390779
- type: cites
  target: source_artifact:pmid-34863776
- type: cites
  target: source_artifact:pmid-37227712
- type: cites
  target: source_artifact:pmid-39672511
- type: cites
  target: source_artifact:ranzco-red-light-nir-pbm-eye-position-statement-2020-11-01
- type: cites
  target: source_artifact:pmid-27484782
- type: cites
  target: source_artifact:pmid-30894210
- type: cites
  target: source_artifact:clinicaltrials-nct02630303-2026-04-24
- type: cites
  target: source_artifact:clinicaltrials-nct03433222-2026-04-24
- type: cites
  target: source_artifact:pmid-26745730
- type: cites
  target: source_artifact:pmid-29178437
- type: cites
...
protocol:
  ...
  - Red-only, amber/yellow, blue/acne, neck, under-eye-only, full-body panel, post-procedure, PDT/photosensitizer/photoconverter, laser/IPL, and ophthalmology PBM evidence belongs to adjacent variants unless explicitly cited as boundary context.
...
- claimId: eye-protection-required
  type: safety
  text: 'Eye protection is a required control for face-adjacent red/NIR use: the protocol should require manufacturer-specified inserts, shields, or goggles, direct-gaze avoidance, and stop-use rules for any ocular or visual symptom.'
  strength: high
  sourceKeys:
  ...
  caveats:
  - MAUDE reports, blue-mask recall/case records, broader laser/light safety reviews, FDA summaries, and ophthalmic safety sources cannot estimate incidence for this red+NIR cosmetic starter; they support conservative guardrails.
- claimId: skin-pigment-photosensitivity-screening
  type: safety
  text: Screening should explicitly ask about pigment risk, melasma or post-inflammatory hyperpigmentation concerns, photosensitizing medications or conditions, active irritated or healing skin, suspicious or unexplained lesions, active/recent skin cancer or other cancer concern in the treatment area, recent cosmetic light/laser/IPL/filler/PDT procedures, photoconverter exposure, and pregnancy/lactation boundaries before unsupervised setup.
  strength: moderate
  sourceKeys:
  ...
  caveats:
  - Many screening sources concern visible light, UV-associated photosensitivity, lasers, IPL, PDT, medical procedures, or oncologic uncertainty rather than LED-only red/NIR masks; this is conservative screening language.
  - No extracted pregnancy or lactation source supports a safety claim; those users need clinician guidance rather than automated clearance.
- claimId: adjacent-variants-not-efficacy-proof
  type: evidence_scope
  text: Red-only, amber/yellow, blue/acne, neck/decollete, under-eye-only, handheld, large-panel, whole-body, post-procedure, PDT/photosensitizer/photoconverter, laser/IPL, ophthalmology, transcranial, and intranasal PBM records should remain adjacent, safety, or exclusion context rather than direct efficacy proof for this facial red+NIR photoaging starter.
  strength: high
  sourceKeys:
  - source_artifact:pmid-36780572
  - source_artifact:pmid-39133416
...
- claimId: onboarding-is-conditional
  type: design_guardrail
  text: Experiment onboarding is appropriate only as a gated planning flow for an adult facial/periocular red+NIR LED/IRED wrinkle or texture mask with identifiable device specs, eye protection, nonthermal/no-UV/no-blue boundaries, adult and pregnancy/lactation gates, baseline photos, session logging, and conservative stop rules.
  strength: moderate
  sourceKeys:
  - source_artifact:pmid-39960921
  - source_artifact:pmid-32649063
  ...
  - source_artifact:pmid-36722207
  caveats:
  - If device specs, eye protection, nonthermal comfort, adult-only eligibility, pregnancy/lactation status, or logging are unresolved, Murph should educate and defer rather than create an active run.
safety:
  cautionLevel: moderate
...
1. The user is an adult and has no unresolved pregnancy or lactation boundary.
2. The exact device model is known.
3. The user can identify a red/NIR wrinkle or texture mode.
4. The face treatment area is predefined; neck, decollete, scalp, wound, acne, full-body, ophthalmology, transcranial, intranasal, or other non-face targets are excluded.
5. Eye protection is available and will be used every session.
6. The device is nonthermal in use and does not require blue, UV, PDT, photosensitizer/photoconverter, or heat-seeking modes for this run.
7. The user has a baseline photo workflow and a session-log path.
8. Safety screening does not produce an unresolved eye, pigment, photosensitivity, active/healing skin, suspicious-lesion, recent-procedure, pregnancy/lactation, or medication concern.

These gates come from the direct and near-direct home-mask evidence, device-parameter context, methods limitations, and safety sources; pregnancy/lactation is included as an unresolved boundary rather than a safety claim. They are not claims that every consumer device is safe or effective. [source_artifact:pmid-39960921; source_artifact:pmid-32649063; source_artifact:fda-k230124-led-facewear-mask-eye-protection-2023-02-09; source_artifact:pmid-39122507; source_artifact:pmid-41032498]
...
- red-only, amber/yellow, blue/acne, neck, under-eye-only, whole-body, laser/IPL, PDT/photosensitizer/photoconverter, ophthalmology, transcranial, or intranasal PBM evidence directly supports this protocol;
...
Eye protection is non-negotiable. Use the manufacturer-specified inserts, shields, or goggles, do not stare at active LEDs, and stop for any eye discomfort or visual symptom. Ocular adverse-event reports, broader facial light-device safety reviews, blue-mask safety records, FDA mask summaries, and ophthalmic safety sources support conservative eye-protection language even though they do not estimate red/NIR mask incidence. [source_artifact:pmid-39122507; source_artifact:pmid-39335685; source_artifact:pmid-37533142; source_artifact:pmid-32541484; source_artifact:tga-neutrogena-led-mask-eye-damage-recall-2019-07-17; source_artifact:fda-currentbody-series-2-k250966-2025-06-25; source_artifact:fda-k221775-led-light-therapy-mask-eye-protection-2022-12-20; source_artifact:fda-k230124-led-facewear-mask-eye-protection-2023-02-09; source_artifact:fda-k243040-led-light-therapy-mask-eye-shield-2024-09-27; source_artifact:pmid-35606999; source_artifact:pmid-28891192; source_artifact:pmid-29552271; source_artifact:pmid-35333214; source_artifact:doi-10.5318-wjo.v4.i1.1]

Also screen conservatively for pigment concerns, photosensitizing medications or topicals, active or healing skin, suspicious lesions or active/recent cancer concerns, recent cosmetic procedures, pregnancy or lactation, and PDT/photosensitizer/photoconverter exposure. Many of these sources are adjacent to LED-only red/NIR masks, and no extracted source clears pregnancy or lactation; the right conclusion is not “red/NIR is proven harmful,” but “do not turn unresolved higher-risk context into an unsupervised self-experiment.” [source_artifact:pmid-20410914; source_artifact:pmid-24888214; source_artifact:pmid-26121474; source_artifact:pmid-32289393; source_artifact:pmid-33640508; source_artifact:pmid-33640513; source_artifact:pmid-30227084; source_artifact:pmid-39899363; source_artifact:pmid-40650752; source_artifact:pmid-30888626; source_artifact:pmid-33491908; source_artifact:pmid-34451820; source_artifact:pmid-21879777; source_artifact:pmid-3530309; source_artifact:pmid-19438994; source_artifact:pmid-25192842; source_artifact:bmla-drugs-and-lasers-ipls-2018-11-30; source_artifact:cdc-sun-exposure-photosensitizing-medications-2025-04-23; source_artifact:dermnet-drug-induced-photosensitivity-2026-04-24; source_artifact:pmid-36722207; source_artifact:pmid-16581685; source_artifact:doi-10.1016-j.mla.2006.06.001; source_artifact:pmid-18254808; source_artifact:pmid-19397672; source_artifact:pmid-23551853; source_artifact:pmid-30074109; source_artifact:pmid-25266806; source_artifact:clinicaltrials-nct07054710-cosmetic-light-mask-2026-04-24; source_artifact:bmla-laser-ipl-treatment-guidelines-2019-05-01; source_artifact:pmid-30506819; source_artifact:pmid-34575408; source_artifact:pmid-29552272; source_artifact:pmid-20456545; source_artifact:pmid-27257391]
