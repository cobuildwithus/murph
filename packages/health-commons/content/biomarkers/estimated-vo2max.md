...
summary: A consumer-device cardio-fitness estimate that can show whether interval training is nudging fitness in the right direction, while staying noisier than a lab VO2max test.
...
Estimated VO2max is a practical signal for Norwegian 4x4 because the intervention literature targets cardiorespiratory fitness, but most people have consumer wearable estimates rather than lab testing.
