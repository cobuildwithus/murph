...
# Default inputs match the Health Commons red-light-glasses-before-bed artifact manifest.

script_dir="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
repo_root="$(cd -- "$script_dir/../../.." && pwd)"
manifest_path="${1:-$repo_root/packages/health-commons/content/artifacts/red-light-glasses-before-bed/research-artifacts.json}"
