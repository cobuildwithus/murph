...
// 16 kHz mono PCM WAV is ~1.9 MiB/min, so this covers ~16 minutes of the
// local-whisper WAV normalization path and much longer for remote-only MP3
// sanitization or passthrough compressed originals. Keep in sync with
// HOSTED_TRANSCRIBE_MAX_BODY_BYTES in apps/cloudflare.
const REMOTE_TRANSCRIPTION_MAX_INPUT_BYTES = 32 * 1024 * 1024;
