...
export const VAULT_LAYOUT = Object.freeze({
  ...
  rawIntegrationsDirectory: "raw/integrations",
  rawMeasurementsDirectory: "raw/measurements",
  rawMealsDirectory: "raw/meals",
  rawSamplesDirectory: "raw/samples",
  rawWorkoutsDirectory: "raw/workouts",
...
export const REQUIRED_DIRECTORIES = Object.freeze([
  ...
  VAULT_LAYOUT.rawIntegrationsDirectory,
  VAULT_LAYOUT.rawMeasurementsDirectory,
  VAULT_LAYOUT.rawMealsDirectory,
  VAULT_LAYOUT.rawSamplesDirectory,
  VAULT_LAYOUT.rawWorkoutsDirectory,
