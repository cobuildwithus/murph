import {
  ...
  OBSERVATION_GRAINS as CONTRACT_OBSERVATION_GRAINS,
...
export const VAULT_PATHS = Object.freeze({
  ...
  rawCapturesRoot: VAULT_LAYOUT.rawCapturesDirectory,
...
export const OBSERVATION_GRAINS = CONTRACT_OBSERVATION_GRAINS;
