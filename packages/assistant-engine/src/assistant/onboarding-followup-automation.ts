...
export const MURPH_ONBOARDING_FOLLOWUP_AUTOMATION =
  {
    ...
    instructions: [
      ...
      '',
      'Success criteria: onboarding is no longer open, or one skill-approved onboarding action or question usefully advances the relationship.',
      '',
      ...
      '',
      "Output: send one brief, natural, low-pressure in-chat continuation only when it advances unfinished onboarding. Ask at most one question. Do not mention internal state, setup completion, or this automation, and do not use a fixed script. The user's reply will be handled by the next normal Murph onboarding turn.",
    ].join('\n'),
