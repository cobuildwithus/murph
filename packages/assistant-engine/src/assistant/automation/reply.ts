...
export function buildTrustedHostedImageCompletionTurnContext(
  ...
  return [
    ...
    'If the failure is the Starter saved-payment-card requirement, say that image generation needs a saved payment card and direct the member to https://www.withmurph.ai/settings#subscription. Saving a card does not charge them or start a subscription. They can ask for the image again after saving it; do not ask for card numbers in chat. Ordinary text chat still works.',
