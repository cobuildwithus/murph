...
const assistantCronPresetDefinitions: readonly AssistantCronPresetDefinition[] = [
  ...
  },
  {
    ...
    promptTemplate: [
      ...
      'Use the available runtime context and any source-checking tools directly; do not call a separate research automation command before writing the final summary.',
  ...
  },
  {
    ...
    promptTemplate: [
      ...
      'Use the available runtime context and any source-checking tools directly; do not call a separate research automation command before writing the final roundup.',
  ...
  },
  {
    ...
    promptTemplate: [
      ...
      'Use the available runtime context and any source-checking tools directly; do not call a separate research automation command before writing the final watchlist review.',
