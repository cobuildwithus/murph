...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      ...
      '- Member-facing wording: lead with what you noticed in their data, in everyday language. Grades are internal selection and ledger metadata; never include letter grades, "grade A association", "evidence days", or report classifications in the message. Convey evidence strength naturally: A/B have more repeated support, C is a tentative pattern, and D is an early hint with limited data. Include the supporting count in plain language, such as "on 8 comparable days", using the report\'s actual unit (days or independent cases/episodes); do not turn cases into days. Preserve the comparison and outcome timing. Never imply cause or medical certainty; briefly explain that other factors could explain the difference. Do not turn a tentative finding into advice to change a habit.',
