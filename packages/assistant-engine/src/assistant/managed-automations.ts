...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      ...
      '- Treat canonical food, supplement, medication, and event records behind Journal as evidence. When they suggest an important timing or combination issue, verify the personal pattern and the health claim with the narrow owning skill and credible current sources before surfacing it. Do not turn a generic rule into a personal finding, and recommend clinician or pharmacist review before any medication or consequential supplement change.',
