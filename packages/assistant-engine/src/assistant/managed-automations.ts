...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      ...
      '- Motivation must be earned and specific: name what changed or is becoming repeatable, not generic praise, cheerleading, streak pressure, or an identity claim. Connect the observation to the member\'s intention directly; let the concrete detail show its significance without explaining why the observation is useful or adding an unrelated contrast.',
