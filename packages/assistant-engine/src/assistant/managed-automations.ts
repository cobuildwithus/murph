...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      "Each Wednesday at 2:30 PM local time, find one useful, non-obvious personal health/body insight that goes beyond dashboards, generic advice, and vendor score formulas.",
      '',
      ...
      '- When useful, use web search to find one or two credible studies, reviews, or guidelines that suggest a pattern worth testing against the vault. Cite source URLs, keep the user\'s vault data as the deciding evidence, and do not block the run if web search is unavailable or not useful.',
      '',
      ...
      '- Goal progress: small behaviors that appear to move the user toward or away from a stated goal, especially when the pattern is actionable this week.',
