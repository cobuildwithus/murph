...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      ...
      '- Then, only when the finding clears the bar, send one concise note in plain adult language: what you noticed, the simple translation, the evidence, why it may matter, and a light optional follow-up.',
