...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      ...
      '- Use the knowledge write surface, for example: `vault-cli knowledge upsert --slug weekly-health-insight-YYYY-MM-DD --title "Weekly health insight - YYYY-MM-DD" --body <markdown> --source-path <canonical-vault-path>`. Cite only canonical vault source paths, never `derived/**` or `.runtime/**` paths.',
