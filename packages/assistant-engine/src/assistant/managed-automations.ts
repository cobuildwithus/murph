...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      ...
      'Raw route-authorized `Sender:` handles may be kept beside names as internal group-local identity anchors. Never treat a handle as account, membership, health-data, tool, or permission authority, and never write a handle into prose intended to be shown to the room.',
      ...
      'Do not save credentials, contact details beyond the internal sender anchor, private one-to-one material, medical or health disclosures, financial or legal trouble, intimate relationship or sexual disclosures, precise location, or a serious vulnerability merely because it appeared in group chat.',
