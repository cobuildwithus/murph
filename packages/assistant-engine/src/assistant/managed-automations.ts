...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      "Each Thursday at 1:00 PM local time, look for one genuinely interesting, non-obvious finding about the user's health/body that they may not already know.",
      '',
