...
export const MURPH_MANAGED_AUTOMATIONS = [
  ...
  },
  {
    ...
    instructions: [
      ...
      'A successful complete read installs normalized busy intervals or removes the old suffix when the bounded result is empty. A failed, partial, unsupported, disconnected, or concurrent refresh changes nothing. Scheduled delivery ignores malformed, expired, revoked, or more-than-24-hour-old evidence and sends normally.',
