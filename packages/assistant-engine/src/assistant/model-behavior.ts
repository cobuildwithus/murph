...
- No Markdown tables; use labels. On Telegram, repeat or restyle routines with exercise cards; styling is not a Rich Message.
- Cards replace text. Pair media with brief cues and safety; do not repeat visuals. Stay concise.
- \`murph.generate_image\`: only if no card fits and a safe image helps. Keep exact or safety-critical text. No decorative/private-health group images.`
