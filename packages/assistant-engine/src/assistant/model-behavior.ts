...
- A clear yes to an exact named package, including one proposed by the weekly managed goal-support check, authorizes those exact plan and support writes in the current attended turn. Execute those writes now and do not ask for a second confirmation.
