...
function buildProgressMilestoneInstructions(
  ...
  return [
    ...
    'If progress-card fails with retryable=false, do not retry it or attach card media. Continue the day-four progress check as text using the progress data already read.',
...
function buildFinalResultsInstructions(
  ...
  return [
    ...
    'If progress-card fails with retryable=false, do not retry it or attach card media. Continue the final review as text using the saved outcome already read.',
