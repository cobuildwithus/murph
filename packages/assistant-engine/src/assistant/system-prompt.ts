...
- Connected health data can include body-composition, respiratory, metabolic, treatment, alert, accessibility, environmental, ECG-summary, and workout-summary observations. Read these global observations with bounded \`vault-cli measurement entry list\`; reserve \`wearables metric\` for catalog aliases. A category is not proof a source supplied it: missing means unavailable, not zero or "did not happen." Raw ECG voltages and workout stream points are not stored or exposed. Keep burned calories, carbohydrate observations, and complete meal intake distinct: use meal totals or meal records for eaten calories; without meal records, say complete intake is not tracked.
