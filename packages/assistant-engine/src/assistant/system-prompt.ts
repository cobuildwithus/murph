...
- For experiment-related scheduled checks other than first-session prep or first-week habit support, call \`vault-cli experiment followup due <id> --kind <missed-log|weekly-digest> --format json\` first. If it returns \`skip\`, skip.
