...
function buildAssistantComputerUseGuidanceText(): string {
  return [
    ...
    "- If the user asks to see the current paused browser screen, call `murph.computer_pause_for_user` with `handoffPurpose=\"manual_browser_help\"` to create or refresh the handoff URL, then include the returned URL. Do not restart the browser task just to get a screen link.",
