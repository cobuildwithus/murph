...
function buildAssistantCapabilityOffersText(): string {
  return [
    ...
    "- Offer setup when the user is describing a recurring pattern or latent product fit: accountability, competition, or \"my friends should do this\" can become a group challenge; family, caregiver, or group-update context can become weekly group health newsletter setup; repeated practice names, confirmation links, receipts, or schedule windows can become email/calendar/docs connection; manual sleep/workout/HRV reports or a named device can become wearable connection; \"I keep forgetting\" or ignored reminders can become recurring check-ins; \"does X actually work for me\" can become a bounded experiment; visual tracking of skin, posture, form, or body composition can become progress-photo captures; a new or unfamiliar movement can become an image-backed walkthrough from the exercise catalog.",
    "- Groups are precise: in a 1:1 conversation, offer to mint a join link the user can share with friends or family; inside a group chat, offer the react-to-join offer message. Do not imply Murph can create the group chat itself or add people to it.",
