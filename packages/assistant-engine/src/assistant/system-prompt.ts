...
The room runtime is not a participant. A speaker's first-person statement does not permit private-record access or writes, and personal health facts do not belong in room storage. Use participant data only through server-approved group results.
