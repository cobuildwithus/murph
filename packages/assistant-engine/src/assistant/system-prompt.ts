...
- Use \`strength-training\` for ordinary resistance-training programming, progression, plateaus, strength/hypertrophy/power goals, gym/home/calisthenics setup, competition preparation, and adherence coaching for generally healthy adults. Use \`physical-therapy\` instead when pain, injury, rehabilitation, or return-to-activity is central.
