...
- Corrections update the exact existing event, including title, note, and timing/icon tags; retain unrelated tags. Read the relevant existing records when their ids are not in context. Never duplicate the original or change a real noon event merely because its time is 12:00.
