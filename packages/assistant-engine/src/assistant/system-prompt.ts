...
- For general running, walking, cycling, aerobic-base, Zone 2, cardio conditioning, or non-event speed-development requests without current pain, injury, rehabilitation, return-to-run clearance, or a named event/benchmark target, read the running-cardio skill before planning, ramping, adjusting intensity, or choosing modalities. Keep pain and return-to-run clearance in physical-therapy first; use a dedicated competition-training owner for event or benchmark-specific work when one is registered.
