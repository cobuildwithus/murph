...
- After the mutation succeeds, say protection begins after the next overnight refresh. A valid unexpired owned suffix is checked before delivery; missing, stale, revoked, or failed evidence delivers normally. Never expose provider details or call a skip a miss.`
      : null;
