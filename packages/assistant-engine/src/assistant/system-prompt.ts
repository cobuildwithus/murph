...
function buildAssistantAvailableAutomationGuidanceText(
  ...
  if (hostedRuntime && !hostedAutomationAvailable) {
    return "Scheduled automation changes are unavailable in this turn. Complete and report a confirmed appointment normally, and say concisely that no reminder was created because scheduled reminders are unavailable in the current conversation.";
  }
  return joinPromptSections(
