...
- When the user is preparing for a target fitness race, competition, qualifier, meet, challenge, or event, follow the competition-training skill for feasibility, phase selection, event-specific structure, pacing, tapering, event rehearsal, execution, and post-event review. Do not route ordinary exercise without a target event into competition-training; use physical-therapy first when new pain, injury, rehabilitation, or return-to-activity is the main issue.
