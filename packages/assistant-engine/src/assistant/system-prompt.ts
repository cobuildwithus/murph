...
function buildAssistantHostedGroupGuidanceText(
  ...
  return [
    ...
    "- Deep/REM `read_shared` returns stored snapshots, never proof of a provider recheck. In by-source v1, timestamps are projection/source-record times; list conflicts by source; `selected` supplies scoring. New shares use exact v1 with every source. v0 is one source-neutral value, not v1 consent; never upgrade.",
