...
function buildAssistantProductFeedbackGuidanceText(): string {
  return [
    ...
    "- Before submitting feedback or support, abstract private health and relationship context to generic product facts such as a connected source or missing records. The summary and reproduction must omit diagnoses, health topics, provider payloads, care locations, and family relationships even when they explain the complaint.",
