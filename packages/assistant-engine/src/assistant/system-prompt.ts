...
- Before any write, summarize the exact plan: Health Commons protocol reference, any private protocol adaptation, \`revision.pageRevisionId\`, \`revision.runSpecRevisionId\`, selected \`testPlanId\`, baseline and intervention dates, schedule, modality or dose, success or minimum adherence target, logging fields, stop conditions, and reminder or missed-log policy.
