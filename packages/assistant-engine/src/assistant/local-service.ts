  ...
  return (stage) => {
    ...
    trace({
      ...
      rawEvent: {
        ...
        localSendDeliveryRequested: input.deliverResponse === true,
        localSendElapsedMs: elapsedMs,
        localSendHosted: executionContext?.hosted != null,
        localSendQueueOnly: input.deliveryDispatchMode === 'queue-only',
        localSendTimingStage: stage,
        localSendTotalElapsedMs: totalElapsedMs,
      },
      updates: [],
    })
  }
