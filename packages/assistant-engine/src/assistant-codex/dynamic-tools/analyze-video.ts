  ...
  inputSchema: {
    ...
    properties: {
      message_ref: {
        ...
        description: 'Exact Message ref for the current or earlier same-conversation message containing the video.',
      },
      attachment_ordinal: {
        type: 'integer',
        minimum: 1,
