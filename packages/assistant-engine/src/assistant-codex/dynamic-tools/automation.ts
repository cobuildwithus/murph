...
const inspectAutomationArgumentsSchema = z.object({
  ...
  lookup: automationIdentifierSchema.describe(
    'Exact automationId returned by save or a prior inspection.',
  ),
}).strict()
