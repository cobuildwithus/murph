...
const saveAutomationArgumentsSchema = z.object({
  ...
  contextReferences: automationContextReferencesSchema
    .optional()
    .describe(
      'Exact canonical records this automation concerns. These trusted host-visible ids are routing and interpretation context only, never mutation authority.',
    ),
...
const patchAutomationArgumentsSchema = z.object({
  ...
  contextReferences: automationContextReferencesSchema
    .optional()
    .describe(
      'Complete replacement for the exact canonical records this automation concerns. Use [] to clear. Routing and interpretation context only; never mutation authority.',
    ),
