...
const hostedAutomationAssistantTargetOverrideSchema = z
  .object({
    model: z
      ...
      .optional()
      .describe(
        'Optional exact model id for this automation turn only: gpt-5.6-luna for self-contained cues with no reads or tools, gpt-5.6-terra for bounded contextual judgment, or gpt-5.6-sol for complex reasoning. Omit to inherit the conversation model.',
      ),
    reasoningEffort: z
