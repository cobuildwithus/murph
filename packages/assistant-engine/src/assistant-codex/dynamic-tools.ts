...
const groupArgumentsSchema = z.discriminatedUnion('action', [
  ...
  z
    .object({
      action: z.literal('leave_current'),
    })
    .strict(),
  z
    .object({
...
function parseGroupArguments(
  ...
  if (
    ...
    || parsed.data.action === 'leave_current'
  ) {
