  ...
  inputSchema: {
    ...
    properties: {
      ...
      displayName: {
        ...
        description:
          'Group display name. Required for action="update_display_name"; optional for action="create_join_link" or action="post_join_offer" only when it is the name the group chose.',
      },
      avatarSource: {
        type: 'string',
