...
export const MURPH_ATTACH_RESPONSE_CARD_TOOL = {
  ...
  description:
    ...
    'After successfully starting or resuming one canonical live workout on a private direct card route, attach one verified structured workout card as the complete response. Do not send a text-only acknowledgement or wait for a separate card request. ' +
