...
describe('applyMurphManagedAutomations', () => {
  ...
  it('creates the managed health automations in a fresh vault', async () => {
    ...
    expect(insightRecord?.instructions).toContain('assistant onboarding status --format json')
    expect(insightRecord?.instructions).not.toContain('assistant onboarding resume-context')
    expect(insightRecord?.instructions).toContain('If the command errors')
    expect(insightRecord?.instructions).toContain('not valid JSON')
    expect(insightRecord?.instructions).toContain('missing or unknown')
    ...
    expect(researchScoutRecord?.instructions).toContain('assistant onboarding status --format json')
    expect(researchScoutRecord?.instructions).not.toContain('assistant onboarding resume-context')
    expect(researchScoutRecord?.instructions).toContain('If the command errors')
    expect(researchScoutRecord?.instructions).toContain('not valid JSON')
    expect(researchScoutRecord?.instructions).toContain('missing or unknown')
