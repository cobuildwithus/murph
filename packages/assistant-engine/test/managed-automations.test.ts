...
describe('applyMurphManagedAutomations', () => {
  it('creates the managed health automations in a fresh vault', async () => {
    ...
    expect(insightRecord?.instructions).toContain('weekly-health-insights')
    expect(insightRecord?.instructions).toContain('knowledge upsert')
    expect(insightRecord?.instructions).toContain('full-page replacement')
    expect(insightRecord?.instructions).toContain('complete page body')
    expect(insightRecord?.instructions).toContain('all existing entries unchanged')
