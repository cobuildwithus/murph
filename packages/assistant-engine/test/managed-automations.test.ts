...
describe('applyMurphManagedAutomations', () => {
  it('creates the managed health automations in a fresh vault', async () => {
    ...
    expect(insightRecord?.instructions).toContain('weekly-health-insight-*')
    expect(insightRecord?.instructions).toContain('weekly-health-insight-YYYY-MM-DD')
    expect(insightRecord?.instructions).toContain('knowledge show weekly-health-insight-YYYY-MM-DD')
    expect(insightRecord?.instructions).toContain('knowledge upsert')
    expect(insightRecord?.instructions).toContain('--create-only')
    ...
    expect(insightRecord?.instructions).toContain('do not overwrite it')
    ...
    expect(insightRecord?.instructions).toContain('Only older pages should disqualify')
