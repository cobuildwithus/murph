...
describe('group context personalization', () => {
  ...
  it('keeps the public song tool contract narrow and authority preserving', () => {
    expectContainsAll(MURPH_GENERATE_SONG_TOOL.description, [
      ...
      'After this description establishes a call-ready ordinary request, read `$MURPH_ASSISTANT_SKILLS_ROOT/music-generation/SKILL.md` before constructing the provider prompt and calling.',
