export const historicalRecurringOnboardingFollowupDefinition = {
...
export const immediatePreviousOneshotOnboardingFollowupDefinition = {
  continuityPolicy: 'preserve' as const,
  instructions: [
...
export const legacyOnboardingFollowupDefinition = {
  continuityPolicy: 'preserve' as const,
  instructions: [
...
export const onboardingFollowupPredecessorDefinitions = [
  {
    definition: immediatePreviousOneshotOnboardingFollowupDefinition,
    label: 'PR 1203 one-shot',
    schedule: {
      at: '2026-04-09T13:30:00.000Z',
      kind: 'at' as const,
    },
  },
  {
    definition: historicalRecurringOnboardingFollowupDefinition,
    label: 'historical recurring',
    schedule: {
  ...
  {
    definition: legacyOnboardingFollowupDefinition,
