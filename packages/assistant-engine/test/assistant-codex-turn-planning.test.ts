...
describe('assistant Codex turn planning', () => {
  it('characterizes complete route-plan outputs across planner branch families', async () => {
    ...
    expect(Object.fromEntries(
      ...
      direct: '5c77ffa3330704279d51230a30ad9414bb75144b6df169e81ef446a6c19da3b2',
      group: 'ab6970fdcf6f4cdc55f064354953f060d171f6c3dd8571ee0c25eb0956059f16',
      ...
      scheduledEmail:
        '621756a5791774ad4dadcbd1ecc5f372863a7f61c8b05bd417fc1312d2f647d2',
    })
  })
  ...
  it.each([{
    ...
    expect(plan.developerInstructions).toContain(
      `For every other onboarding turn, read and follow \`${skillRef}\` before interpreting or acting on an onboarding answer or decision to advance, pause, defer, skip, decline, or complete onboarding`,
    )
