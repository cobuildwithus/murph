...
describe('assistant Codex turn planning', () => {
  it('characterizes complete route-plan outputs across planner branch families', async () => {
    ...
    expect(Object.fromEntries(
      ...
      {
        "direct": "1ce697c8b35fda3610cb7cc98ec61fedd85b2e1bd954b8ac902b720189c871de",
        ...
        "scheduledEmail": "fae34cac57d26bf6a1ff4afee34463b820e90e7735f96e3e25d8a93fe7d1a60c",
      }
    `)
  })
