...
describe('assistant codex runtime', () => {
  ...
  it('retires the exact failed process when replacement races teardown cleanup', async () => {
  ...
  it('keeps the pending cold-start reason when replacement construction throws', async () => {
