...
description: Public fallback for group humor in builds without managed comedy behavior.
---

# Group-Chat Comedy

This build does not include Murph's managed group-comedy behavior.

This public fallback intentionally contains no managed comedy, callback, canon,
roast, song, voice-memo, or format-rotation policy. Follow the resident public
