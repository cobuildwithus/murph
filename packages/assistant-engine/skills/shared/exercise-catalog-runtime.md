...
5. When the current turn is a movement-instruction turn and the delivery surface
...
6. If acute pain or safety requires an immediate action, give the minimal plan
