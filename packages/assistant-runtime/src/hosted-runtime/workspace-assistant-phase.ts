...
export async function runHostedWorkspaceAssistantPhase(
  ...
  try {
    ...
    const invocationLocalAssistantWake =
      resolveHostedInvocationLocalAssistantWakeProjection({
        assistantMetrics,
        input,
      });
  ...
  return isHostedSystemMailboxWakeCandidate(systemMailboxWake)
    ? selectHostedRuntimeOwnerWakeCandidate({
        backgroundCandidates: [
          ...
          createHostedDeviceActivityAutomationWakeCandidate(
            input.deviceActivityAutomation ?? null,
          ),
...
async function writeHostedAssistantPassRuntimeLog(input: {
  ...
  input: HostedWorkspaceRuntimeAssistantPhaseInput;
  nextWakeAt: string | null;
  nextWakeReason: string | null | undefined;
  progressed: boolean;
  systemMailboxWakeAt: string | null;
}): Promise<void> {
  await writeHostedRuntimeLogBestEffort({
...
function resolveHostedInvocationLocalAssistantWakeProjection(input: {
  assistantMetrics: HostedAssistantMetrics;
  input: HostedWorkspaceRuntimeAssistantPhaseInput;
}): Pick<
  HostedWorkspaceRunnerAssistantPhaseResult,
