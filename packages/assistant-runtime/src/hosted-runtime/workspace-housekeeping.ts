...
const HOSTED_LEGACY_WEARABLE_RECEIPT_COMPACTION_UNBOUNDED_BYTES =
  Number.POSITIVE_INFINITY;
export const HOSTED_LEGACY_WEARABLE_RECEIPT_COMPACTION_MAX_BYTES_READ =
  0;
export const HOSTED_LEGACY_WEARABLE_RECEIPT_COMPACTION_MAX_CANDIDATE_BYTES =
  HOSTED_LEGACY_WEARABLE_RECEIPT_COMPACTION_UNBOUNDED_BYTES;
