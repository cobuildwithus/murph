...
test('assistant onboarding commands read and write the shared lifecycle state', async () => {
  ...
  assert.equal(statusResult.statePath, 'redacted:/tmp/vault/.runtime/operations/assistant/state/onboarding/conversation.json')
  ...
  assert.equal(completeResult.onboarding.completedReason, 'concrete_request')
