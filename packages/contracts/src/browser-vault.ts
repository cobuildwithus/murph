export const BROWSER_VAULT_REPLICA_SCHEMA =
  "murph.browser-vault-replica" as const;
 ...
 */
export const BROWSER_VAULT_REPLICA_CURRENT_GENERATION = 17 as const;
...
export const BROWSER_VAULT_METRIC_BUCKET_COUNT =
  BROWSER_VAULT_METRIC_BUCKET_IDS.length;

export type BrowserVaultMetricBucketId =
  (typeof BROWSER_VAULT_METRIC_BUCKET_IDS)[number];

const browserVaultMetricBucketIds = new Set<string>(
  BROWSER_VAULT_METRIC_BUCKET_IDS,
);

export function isBrowserVaultMetricBucketId(
  value: unknown,
): value is BrowserVaultMetricBucketId {
