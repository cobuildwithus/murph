...
export const immunizationImportPayloadSchema = toInputJsonSchema(immunizationImportPayloadContract);
...
export const schemaCatalog = Object.freeze({
  ...
  "immunization-import-payload": immunizationImportPayloadSchema,
