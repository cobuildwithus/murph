...
const sparsePerRecord = () =>
  policy("timeseries", "sparse", "default", "canonical_per_record", JUNCTION_LONG_HISTORY_DAYS, JUNCTION_SPARSE_HISTORY_CHUNK_DAYS);
...
export const JUNCTION_RESOURCE_POLICIES = Object.freeze({
  ...
  body_mass_index: sparsePerRecord(),
  ...
  lean_body_mass: sparsePerRecord(),
  ...
  waist_circumference: sparsePerRecord(),
