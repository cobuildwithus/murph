...
export const JUNCTION_RESOURCE_POLICIES = Object.freeze({
  ...
  forced_expiratory_volume_1: sparsePerRecord(),
  forced_vital_capacity: sparsePerRecord(),
  handwashing: excluded("sparse", "No current product use justifies canonical retention."),
  heart_rate_alert: sparsePerRecord(),
  inhaler_usage: sparsePerRecord(),
  ...
  peak_expiratory_flow_rate: sparsePerRecord(),
  sleep_apnea_alert: sparsePerRecord(),
