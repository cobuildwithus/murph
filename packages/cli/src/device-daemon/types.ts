...
export const HEALTHYBOB_DEVICE_SYNC_PUBLIC_BASE_URL_ENV =
  'HEALTHYBOB_DEVICE_SYNC_PUBLIC_BASE_URL'
export const HEALTHYBOB_DEVICE_SYNC_SECRET_ENV = 'HEALTHYBOB_DEVICE_SYNC_SECRET'
export const HEALTHYBOB_DEVICE_SYNC_HOST_ENV = 'HEALTHYBOB_DEVICE_SYNC_HOST'
export const HEALTHYBOB_DEVICE_SYNC_PORT_ENV = 'HEALTHYBOB_DEVICE_SYNC_PORT'
export const HEALTHYBOB_DEVICE_SYNC_STATE_DB_PATH_ENV =
