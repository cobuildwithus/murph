...
const wearableBodyStateSummarySchema = z.object({
  ...
  carbohydrateIntake: wearableResolvedMetricSchema.optional(),
  date: localDateSchema,
  glucoseCoefficientOfVariation: wearableResolvedMetricSchema.optional(),
  glucoseStandardDeviation: wearableResolvedMetricSchema.optional(),
