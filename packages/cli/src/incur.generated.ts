declare module 'incur' {
  interface Register {
    commands: {
      ...
      'audit receipt': { args: { id: string }; options: { requestId?: string } }
      ...
      'experiment session log': { args: { lookup: string }; options: { requestId?: string; reminderIntentId?: string; date?: string; occurredAt?: string; source?: "manual" | "import" | "device" | "derived"; title?: string; note?: string; interventionType?: string; status?: "completed" | "partial" | "missed" | "skipped"; sessionStatus?: "completed" | "partial" | "missed" | "skipped"; durationMinutes?: number; protocolId?: string; timing?: string; temperatureC?: number; afterExercise?: boolean; symptoms?: string[]; confounders?: string[]; confounder?: string[]; field?: string[] } }
      ...
      'food search-labels': { args: { query?: string }; options: { query?: string; limit?: number; fullLabel?: boolean; generic?: boolean; includeOffMarket?: boolean } }
      ...
      'meal import-json': { args: {}; options: { requestId?: string; input: string; withDailyTotals?: boolean; photo?: string; audio?: string; note?: string; occurredAt?: string | string; source?: "manual" | "import" | "device" | "derived"; ingredient?: string[]; nutritionCalories?: number; nutritionProteinGrams?: number; nutritionCarbsGrams?: number; nutritionFatGrams?: number; nutritionFiberGrams?: number; nutritionSource?: "user" | "label" | "database" | "inherited" | "estimated"; nutritionConfidence?: "low" | "medium" | "high"; nutritionSourceDetail?: string } }
      ...
      'workout exercise remove': { args: { exercise?: string }; options: { requestId?: string; workoutId: string; exerciseId?: string; exerciseOrder?: number; expectedRevision: number } }
