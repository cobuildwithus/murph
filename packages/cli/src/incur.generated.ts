declare module 'incur' {
  interface Register {
    commands: {
      ...
      'age evidence': { args: {}; options: { input?: string; includeTemplates: boolean; includeBenchmarkCards: boolean } }
