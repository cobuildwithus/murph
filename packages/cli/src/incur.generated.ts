declare module 'incur' {
  interface Register {
    commands: {
      ...
      'assistant ask': { args: { prompt: string }; options: { vault: string; requestId?: string; session?: string; alias?: string; channel?: string; identity?: string; participant?: string; thread?: string; codexCommand?: string; codexHome?: string; model?: string; modelProvider?: string; reasoningEffort?: "low" | "medium" | "high" | "xhigh"; sandbox?: "read-only" | "workspace-write" | "danger-full-access"; approvalPolicy?: "never"; profile?: string; deliverResponse?: boolean; deliveryTarget?: string } }
      'assistant chat': { args: { prompt?: string }; options: { vault: string; requestId?: string; session?: string; alias?: string; channel?: string; identity?: string; participant?: string; thread?: string; codexCommand?: string; codexHome?: string; model?: string; modelProvider?: string; reasoningEffort?: "low" | "medium" | "high" | "xhigh"; sandbox?: "read-only" | "workspace-write" | "danger-full-access"; approvalPolicy?: "never"; profile?: string } }
      ...
      'assistant onboarding complete': { args: {}; options: { vault: string; requestId?: string; reason: "user_answered" | "user_declined" | "manual" } }
      ...
      'capture add': { args: {}; options: { vault: string; requestId?: string; media?: string[]; label?: string; bodySite?: string; collection?: string; tag?: string[]; relatedId?: string[]; note?: string; title?: string; occurredAt?: string | string; source?: "manual" | "import" | "device" | "derived"; timeZone?: string } }
      'capture import-json': { args: {}; options: { vault: string; requestId?: string; input: string; media?: string[]; label?: string; bodySite?: string; collection?: string; tag?: string[]; relatedId?: string[]; note?: string; title?: string; occurredAt?: string | string; source?: "manual" | "import" | "device" | "derived"; timeZone?: string } }
      ...
      'chat': { args: { prompt?: string }; options: { vault: string; requestId?: string; session?: string; alias?: string; channel?: string; identity?: string; participant?: string; thread?: string; codexCommand?: string; codexHome?: string; model?: string; modelProvider?: string; reasoningEffort?: "low" | "medium" | "high" | "xhigh"; sandbox?: "read-only" | "workspace-write" | "danger-full-access"; approvalPolicy?: "never"; profile?: string } }
      ...
      'document edit': { args: { id: string }; options: { vault: string; requestId?: string; title?: string; note?: string; occurredAt?: string | string; timeZone?: string; dayKey?: string; source?: "manual" | "import" | "device" | "derived"; tag?: string[]; clearTitle?: boolean; clearNote?: boolean; clearTimeZone?: boolean; clearDayKey?: boolean; clearSource?: boolean; clearTags?: boolean; dayKeyPolicy?: "keep" | "recompute" } }
      ...
      'event edit': { args: { id: string }; options: { vault: string; requestId?: string; title?: string; note?: string; occurredAt?: string | string; timeZone?: string; dayKey?: string; source?: "manual" | "import" | "device" | "derived"; tag?: string[]; clearTitle?: boolean; clearNote?: boolean; clearTimeZone?: boolean; clearDayKey?: boolean; clearSource?: boolean; clearTags?: boolean; dayKeyPolicy?: "keep" | "recompute"; kind?: string } }
      ...
      'experiment session attach': { args: { lookup: string; eventId: string }; options: { vault: string; requestId?: string; replace?: boolean; allowOutOfWindow?: boolean } }
      'experiment session detach': { args: { eventId: string }; options: { vault: string; requestId?: string } }
      'experiment session log': { args: { lookup: string }; options: { vault: string; requestId?: string; date?: string; occurredAt?: string; source?: "manual" | "import" | "device" | "derived"; title?: string; note?: string; interventionType?: string; status?: "completed" | "partial" | "missed" | "skipped"; sessionStatus?: "completed" | "partial" | "missed" | "skipped"; durationMinutes?: number; protocolId?: string; timing?: string; temperatureC?: number; afterExercise?: boolean; symptoms?: string[]; confounders?: string[]; confounder?: string[] } }
      'experiment show': { args: { id: string }; options: { vault: string; requestId?: string } }
      'experiment start': { args: { slug: string }; options: { vault: string; requestId?: string; title?: string; hypothesis?: string; startedOn?: string; status?: "planned" | "active" | "paused" | "completed" | "abandoned"; body?: string; fromProtocol?: string; custom?: boolean; testPlanId?: string; pageRevisionId?: string; runSpecRevisionId?: string; baselineStart?: string; baselineEnd?: string; baselineDays?: number; interventionStart?: string; interventionEnd?: string; interventionDays?: number; modality?: string; scheduleKind?: "dailyLocal" | "cron"; scheduleCron?: string; scheduleLocalTime?: string; scheduleTimeZone?: string; dose?: string; sessionsPerWeek?: number; targetSessions?: number; minimumUsefulSessions?: number; sessionField?: string[]; confounderField?: string[]; stopCondition?: string[]; primaryBiomarkerKey?: string; secondaryBiomarkerKey?: string[]; desiredDirection?: "increase" | "decrease" | "stabilize"; expectedDirection?: string[]; analysisNote?: string[]; remindersEnabled?: boolean; missedLogFollowup?: "never" | "opt_in_only" | "default_on"; weeklyDigestEnabled?: boolean; dryRun?: boolean } }
      ...
      'inbox source add': { args: { source: "telegram" | "email" }; options: { vault: string; requestId?: string; id: string; account?: string; address?: string; backfillLimit: number; provision?: boolean; emailDisplayName?: string; emailUsername?: string; emailDomain?: string; emailClientId?: string; enableAutoReply?: boolean } }
      ...
      'intervention add': { args: { text: string }; options: { vault: string; requestId?: string; duration?: number; type?: string; regimenId?: string; experiment?: string; skipExperimentLink?: boolean; allowOutOfWindow?: boolean; occurredAt?: string | string; source?: "manual" | "import" | "device" | "derived" } }
      'intervention delete': { args: { id: string }; options: { vault: string; requestId?: string } }
      'intervention edit': { args: { id: string }; options: { vault: string; requestId?: string; title?: string; note?: string; occurredAt?: string | string; timeZone?: string; dayKey?: string; source?: "manual" | "import" | "device" | "derived"; tag?: string[]; clearTitle?: boolean; clearNote?: boolean; clearTimeZone?: boolean; clearDayKey?: boolean; clearSource?: boolean; clearTags?: boolean; dayKeyPolicy?: "keep" | "recompute"; type?: string; duration?: number; regimenId?: string; clearDuration?: boolean; clearRegimenId?: boolean } }
      ...
      'measurement add': { args: {}; options: { vault: string; requestId?: string; metric?: string[]; value?: number[]; unit?: string[]; qualifier?: string[]; measurementNote?: string[]; note?: string; title?: string; occurredAt?: string | string; source?: "manual" | "import" | "device" | "derived"; media?: string[]; tag?: string[]; timeZone?: string } }
      'measurement import-json': { args: {}; options: { vault: string; requestId?: string; input: string; note?: string; title?: string; occurredAt?: string | string; source?: "manual" | "import" | "device" | "derived"; media?: string[] } }
      ...
      'supplement list': { args: {}; options: { vault: string; requestId?: string; limit: number; status?: string } }
      ...
      'workout add': { args: { text?: string }; options: { vault: string; requestId?: string; note?: string; title?: string; duration?: number; type?: string; distanceKm?: number; occurredAt?: string | string; source?: "manual" | "import" | "device" | "derived"; media?: string[]; workoutSourceApp?: string; workoutSourceWorkoutId?: string; workoutStartedAt?: string; workoutEndedAt?: string; workoutRoutineId?: string; workoutRoutineName?: string; workoutSessionNote?: string; workoutMedia?: string[]; workoutExercise?: string[]; workoutSet?: string[] } }
      'workout delete': { args: { id: string }; options: { vault: string; requestId?: string } }
      'workout edit': { args: { id: string }; options: { vault: string; requestId?: string; title?: string; note?: string; occurredAt?: string | string; timeZone?: string; dayKey?: string; source?: "manual" | "import" | "device" | "derived"; tag?: string[]; clearTitle?: boolean; clearNote?: boolean; clearTimeZone?: boolean; clearDayKey?: boolean; clearSource?: boolean; clearTags?: boolean; dayKeyPolicy?: "keep" | "recompute"; duration?: number; type?: string; distanceKm?: number; workoutSourceApp?: string; workoutSourceWorkoutId?: string; workoutStartedAt?: string; workoutEndedAt?: string; workoutRoutineId?: string; workoutRoutineName?: string; workoutSessionNote?: string; workoutMedia?: string[]; workoutExercise?: string[]; workoutSet?: string[]; clearDuration?: boolean; clearDistance?: boolean; clearWorkout?: boolean } }
      'workout format import-json': { args: { name?: string; text?: string }; options: { vault: string; requestId?: string; input: string } }
      ...
      'workout format save': { args: { name?: string; text?: string }; options: { vault: string; requestId?: string; workoutFormatId?: string; slug?: string; status?: "active" | "archived"; summary?: string; tag?: string[]; note?: string; templateText?: string; routineNote?: string; exercise?: string[]; setTemplate?: string[]; duration?: number; type?: string; distanceKm?: number } }
      ...
      'workout import-json': { args: { text?: string }; options: { vault: string; requestId?: string; input: string; note?: string; title?: string; duration?: number; type?: string; distanceKm?: number; occurredAt?: string | string; source?: "manual" | "import" | "device" | "derived"; media?: string[] } }
