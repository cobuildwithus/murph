declare module 'incur' {
  interface Register {
    commands: {
      ...
      'food edit': { args: { id: string }; options: { vault: string; requestId?: string; title?: string; slug?: string; status?: "active" | "archived"; summary?: string; kind?: string; brand?: string; vendor?: string; location?: string; serving?: string; calories?: number; proteinGrams?: number; carbsGrams?: number; fatGrams?: number; fiberGrams?: number; nutritionSource?: "user" | "label" | "database" | "inherited" | "estimated"; nutritionConfidence?: "low" | "medium" | "high"; nutritionSourceDetail?: string; alias?: string[]; ingredient?: string[]; tag?: string[]; note?: string; autoLogDailyTime?: string; attachedRegimenId?: string[]; linkRelatedRegimenId?: string[]; clearSummary?: boolean; clearKind?: boolean; clearBrand?: boolean; clearVendor?: boolean; clearLocation?: boolean; clearServing?: boolean; clearNutrition?: boolean; clearAliases?: boolean; clearIngredients?: boolean; clearTags?: boolean; clearNote?: boolean; clearAutoLogDaily?: boolean; clearAttachedRegimenIds?: boolean; clearLinks?: boolean } }
