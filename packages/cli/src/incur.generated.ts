declare module 'incur' {
  interface Register {
    commands: {
      ...
      'workout set log-scheduled': { args: { exercise: string }; options: { requestId?: string; previousWorkoutId: string; routineId: string; exerciseOrder: number; setOrder: number; scheduledOccurrenceAt: string; reminderSentAt: string; acceptedAt: string; type?: "normal" | "warmup" | "dropset" | "failure"; note?: string; reps?: number; weight?: number; weightUnit?: "lb" | "kg"; durationSeconds?: number; distanceMeters?: number; rpe?: number; bodyweightKg?: number; assistanceKg?: number; addedWeightKg?: number } }
