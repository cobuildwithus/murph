declare module 'incur' {
  interface Register {
    commands: {
      ...
      'automation edit': { args: { lookup: string }; options: { requestId?: string; title?: string; slug?: string; status?: "active" | "paused" | "archived"; summary?: string; tag?: string[]; tags?: string[]; continuityPolicy?: "fresh" | "preserve"; triggerKind?: "at" | "every" | "cron" | "dailyLocal" | "deviceActivity"; triggerAt?: string; triggerEveryMs?: number; triggerCron?: string; triggerLocalTime?: string; deviceSource?: "whoop" | "whoop_v2"; activityKind?: string; scheduleKind?: "at" | "every" | "cron" | "dailyLocal"; scheduleAt?: string; scheduleEveryMs?: number; scheduleCron?: string; scheduleLocalTime?: string; channel?: string; deliveryTarget?: string; identityId?: string; participantId?: string; threadId?: string; assistantTargetOverrideModel?: string; assistantTargetOverrideModelProvider?: string; assistantTargetOverrideReasoningEffort?: "low" | "medium" | "high" | "xhigh"; instructions?: string; clearAssistantTargetOverride?: boolean } }
      ...
      'group shared': { args: {}; options: { requestId?: string; kind?: ("group-email.v0" | "sleep-times.v0" | "activity-days.v0" | "workout-days.v0" | "running-minutes-days.v0" | "walking-minutes-days.v0" | "swimming-minutes-days.v0" | "sauna-minutes-days.v0" | "heart-rate-zones-days.v0" | "running-heart-rate-zones-days.v0" | "steps-days.v0" | "max-heart-rate-days.v0" | "distance-days.v0" | "active-calories-days.v0" | "elevation-gain-days.v0" | "floors-climbed-days.v0" | "day-strain-days.v0" | "workout-strain-days.v0" | "activity-score-days.v0" | "vo2-max-days.v0" | "resting-heart-rate-days.v0" | "hrv-days.v0")[] } }
