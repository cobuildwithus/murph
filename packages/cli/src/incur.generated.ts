declare module 'incur' {
  interface Register {
    commands: {
      ...
      'workout import csv': { args: { file: string }; options: { requestId?: string; source?: string; delimiter?: string; weightUnit?: "lb" | "kg"; distanceUnit?: "m" | "km" | "mi"; storeRawOnly?: boolean; correctUnits?: boolean } }
      'workout import inspect': { args: { file: string }; options: { requestId?: string; source?: string; delimiter?: string; weightUnit?: "lb" | "kg"; distanceUnit?: "m" | "km" | "mi" } }
