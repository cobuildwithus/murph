...
export function buildAssistantCliGuidanceText(
  ...
  return [
    ...
    'If the user says they are at a specific restaurant or names a specific restaurant item, try to look up the menu on the web before you turn that into a reusable food. Prefer the restaurant menu or official restaurant page when possible. If the menu is not available in the current session, say that clearly and ask only for the missing details you need.',
