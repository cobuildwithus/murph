...
test('assistant cron presets stay separate from scheduler state until installed', async () => {
  ...
  assert.match(environmentPreset.promptTemplate, /If the research tool is available in this run, use it/u)
  ...
  assert.match(ingestiblePreset.promptTemplate, /If the research tool is available in this run, use it/u)
  ...
  assert.match(frontierPreset.promptTemplate, /If the research tool is available in this run, use it/u)
