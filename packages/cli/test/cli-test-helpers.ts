...
const requiredRuntimeArtifactPaths = [
  ...
  path.join(repoRoot, 'packages/messaging-ingress/dist/linq-webhook.d.ts'),
  path.join(repoRoot, 'packages/messaging-ingress/dist/telegram-webhook.js'),
  path.join(repoRoot, 'packages/messaging-ingress/dist/telegram-webhook.d.ts'),
  path.join(repoRoot, 'packages/messaging-ingress/dist/telegram-webhook-payload.js'),
  path.join(repoRoot, 'packages/messaging-ingress/dist/telegram-webhook-payload.d.ts'),
  ...
  path.join(repoRoot, 'packages/health-commons/dist/index.js'),
  path.join(repoRoot, 'packages/health-commons/dist/index.d.ts'),
  path.join(repoRoot, 'packages/health-commons/dist/runtime.js'),
  path.join(repoRoot, 'packages/health-commons/dist/runtime.d.ts'),
  path.join(repoRoot, 'packages/exercise-library/dist/index.js'),
  path.join(repoRoot, 'packages/exercise-library/dist/index.d.ts'),
  path.join(repoRoot, 'packages/exercise-library/dist/runtime.js'),
  path.join(repoRoot, 'packages/exercise-library/dist/runtime.d.ts'),
