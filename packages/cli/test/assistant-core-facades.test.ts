...
test('cli and split owner packages publish the expected owner dependencies', async () => {
  ...
  assert.equal(assistantEngineManifest.exports?.['./inbox-services/connectors'] !== undefined, true)
  assert.equal(assistantEngineManifest.exports?.['./inbox-services/daemon'] !== undefined, true)
  assert.equal(assistantEngineManifest.exports?.['./inbox-services/promotions'] !== undefined, true)
  ...
  assert.equal(assistantEngineManifest.exports?.['./usecases/document-meal-read'] !== undefined, true)
  assert.equal(assistantEngineManifest.exports?.['./usecases/event-record-mutations'] !== undefined, true)
  assert.equal(assistantEngineManifest.exports?.['./usecases/experiment-journal-vault'] !== undefined, true)
  assert.equal(assistantEngineManifest.exports?.['./usecases/explicit-health-family-services'] !== undefined, true)
  assert.equal(assistantEngineManifest.exports?.['./usecases/record-mutations'] !== undefined, true)
