...
`,
  ...
  it('propagates CLI package coverage failures instead of forcing the release lane green', () => {
    ...
    expect(packageCoveragePlan!.indexOf('"packages/cli|CLI package coverage"')).toBeLessThan(
      packageCoveragePlan!.indexOf('"packages/contracts|Contracts package coverage"'),
    )
    expect(packageCoveragePlan!.indexOf('"packages/contracts|Contracts package coverage"')).toBeLessThan(
      packageCoveragePlan!.indexOf('"packages/device-syncd|Device syncd package coverage"'),
    )
