...
describe('monorepo release flow coverage audit', () => {
  ...
  it('exposes only the package-backed review-gpt runner', () => {
    ...
    expect(pnpmWorkspace).toContain("  '@cobuild/review-gpt@0.5.131>incur': 0.4.5")
    expect(
      pnpmWorkspace
    ...
    expect(reviewGptReadme).toContain(
      'The threshold defaults to 5 minutes and can be raised or lowered with `--minimum-marked-response-time <duration>`',
    )
