...
import { addWorkoutRecord } from '@murphai/vault-inbox/usecases/workout'
import { addWorkoutMeasurementRecord } from '@murphai/vault-inbox/usecases/workout-measurement'
