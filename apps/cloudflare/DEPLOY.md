...
errors out of the receipt. A later protected observer must match the receipt to
100% Worker traffic and the final container versions, image digests, capacities,
and rollout outcomes. Land this public producer before enabling a private
workflow that requires the receipt; the reverse order intentionally fails closed.
