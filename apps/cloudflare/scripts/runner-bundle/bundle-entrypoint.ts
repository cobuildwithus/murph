...
// - entry container-entrypoint.js: 1,426,715B on CI Linux after the
//   2026-07-13 hosted group-withdrawal and operation-scope integration;
// - static boot closure: 7,058,248B on CI Linux after the 2026-07-14 hosted
//   group-leave membership-epoch delivery guard and current-main integration.
//   The forbidden-input guard below keeps clinical intake and other turn-scoped
...
const RUNNER_ENTRYPOINT_BUNDLE_ENTRY_BASELINE_BYTES = 1_426_715;
const RUNNER_ENTRYPOINT_BUNDLE_STATIC_CLOSURE_BASELINE_BYTES = 7_058_248;
