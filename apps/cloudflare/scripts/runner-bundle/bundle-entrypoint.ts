...
// - static boot closure: 7,059,848B on CI Linux for the exact PR 444 head
//   after reconciling Call Circle with the 2026-07-14 mainline integration.
...
const RUNNER_ENTRYPOINT_BUNDLE_STATIC_CLOSURE_BASELINE_BYTES = 7_059_848;
