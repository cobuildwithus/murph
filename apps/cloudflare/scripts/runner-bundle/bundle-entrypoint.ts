...
// - static boot closure: 6,961,132B on CI Linux after the additive
//   preference requested-field compatibility metadata landed in PR 550.
...
const RUNNER_ENTRYPOINT_BUNDLE_STATIC_CLOSURE_BASELINE_BYTES = 6_961_132;
