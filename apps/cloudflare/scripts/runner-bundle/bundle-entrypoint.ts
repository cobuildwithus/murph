...
// - entry container-entrypoint.js: 1,479,670B on CI Linux for the exact
//   PR 560 head 01b5f8dc9c after adding deferred group-reaction context;
// - static boot closure: 7,074,754B on CI Linux for that same head.
...
const RUNNER_ENTRYPOINT_BUNDLE_ENTRY_BASELINE_BYTES = 1_479_670;
const RUNNER_ENTRYPOINT_BUNDLE_STATIC_CLOSURE_BASELINE_BYTES = 7_074_754;
