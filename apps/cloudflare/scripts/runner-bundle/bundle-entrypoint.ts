...
//
// Junction resource-policy history and atomic reconciliation checkpoints extend
// the existing deferred provider and hosted-runtime outputs without adding a
// forbidden boot input. Exact ubuntu assembly measured 9,886,135B total, while
// exact macOS assembly measured 9,933,616B total and a 7,948,296B static closure
// on 2026-08-12. Ratchet the larger platform measurements while retaining the
// established cross-platform tolerances.
const RUNNER_ENTRYPOINT_BUNDLE_TOTAL_BYTES_BUDGET = 9_933_616 + 32_768;
const RUNNER_ENTRYPOINT_BUNDLE_ENTRY_BASELINE_BYTES = 1_619_381;
const RUNNER_ENTRYPOINT_BUNDLE_STATIC_CLOSURE_BASELINE_BYTES = 7_948_296;
