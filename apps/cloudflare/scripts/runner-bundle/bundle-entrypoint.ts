...
// Latest measured from the real assembled bundle on 2026-07-09 after adding
// generated-image capture/retry persistence: CI Linux static boot closure
// 6,600,249B. The entry and local macOS totals below remain from the
// 2026-07-07 selector-scoped vault-share runtime parsing measurement:
// local macOS total 8,018,521B, entry container-entrypoint.js 1,319,436B.
// The static baseline below keeps the reviewed CI value while the tolerance
// covers local emit jitter.
//
...
const RUNNER_ENTRYPOINT_BUNDLE_STATIC_CLOSURE_BASELINE_BYTES = 6_600_249;
