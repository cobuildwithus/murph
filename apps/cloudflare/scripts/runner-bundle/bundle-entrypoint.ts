...
// - entry container-entrypoint.js: 1,474,490B on CI Linux after the accepted
//   conversation delivery-continuation path was added for PR 511;
// - static boot closure: 7,078,454B on CI Linux after the accepted
//   conversation delivery-continuation path was added for PR 511.
...
const RUNNER_ENTRYPOINT_BUNDLE_ENTRY_BASELINE_BYTES = 1_474_490;
const RUNNER_ENTRYPOINT_BUNDLE_STATIC_CLOSURE_BASELINE_BYTES = 7_078_454;
