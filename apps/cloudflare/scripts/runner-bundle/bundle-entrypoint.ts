...
//
// The ordered Linq rich-link identity and partial-delivery correction measured
// 9,796,359B total in CI on 2026-07-29. The graph added no forbidden boot input;
// production assembly below still fails closed if any dimension exceeds its
// reviewed measurement plus the existing allowance.
const RUNNER_ENTRYPOINT_BUNDLE_TOTAL_BYTES_BUDGET = 9_796_359 + 32_768;
