...
// Group Journal capture and structured Journal metrics extend the lazy graph
// without adding a boot input. Exact macOS production assembly measured
// 11,763,067B total on 2026-09-02; ratchet only the total baseline.
const RUNNER_ENTRYPOINT_BUNDLE_TOTAL_BYTES_BUDGET = 11_763_067 + 32_768;
