...
// Clinical and health-record recovery metadata add 8,497 B to the same lazy
// graph. Entry and static-startup limits remain unchanged.
const VAULT_CLI_BUNDLE_TOTAL_BYTES_BUDGET = 9_519_180;
