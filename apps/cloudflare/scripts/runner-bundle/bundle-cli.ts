...
// existing Assistant Engine graph without adding a package. The generalized
// workout CSV import command surface measured 9,152,605 B on both macOS and
// Linux CI on 2026-08-15; it grows the existing CLI/Core graph without adding
// a package. The static startup closure measured 24,950 B. Keep total output
// inside a narrow 32 KiB allowance and static startup inside an 8 KiB
...
const VAULT_CLI_BUNDLE_TOTAL_BYTES_BUDGET = 9_185_500;
