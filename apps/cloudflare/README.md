...
- `HOSTED_AI_USAGE_VERCEL_STRIPE_BILLING_ENABLED` plus `HOSTED_AI_USAGE_STRIPE_RESTRICTED_ACCESS_KEY` when Vercel AI Gateway should emit Stripe meter events directly
