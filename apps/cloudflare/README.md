...
- opt-in runtime integrations such as `LINQ_*`, `TELEGRAM_*`, and `MAPBOX_ACCESS_TOKEN`; native parser binaries and the Whisper model are image-owned and passed to `@murphai/assistant-runtime` as explicit parser toolchain config
