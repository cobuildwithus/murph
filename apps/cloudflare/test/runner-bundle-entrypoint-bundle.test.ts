...
describe("runner bundle container-entrypoint esbuild step", () => {
  ...
  it("resolves the production budgets as the ratcheted baselines plus tolerance", () => {
    ...
    // noise band. Static closure = measured CI Linux baseline (6,818,632B on
    // 2026-07-10 after adding clinical-records to the runner closure) +
    ...
    expect(budgets).toEqual({
      ...
      staticClosureBytes: 6_818_632 + 96_000,
    ...
    expect(budgets.staticClosureBytes).toBeLessThan(7_000_000);
  });
