...
describe("hosted Linq egress authority", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      expectedRetryable: true,
      expectedStatus: 503,
      label: "a provider-accepted Web reply awaiting its receipt",
      row: {
    ...
    },
    {
      ...
      expectedStatus: 409,
      label: "a delivered Web reply",
      row: {
        acceptedAt: new Date("2026-07-14T00:05:00.000Z"),
        deliveredAt: new Date("2026-07-14T00:05:01.000Z"),
        failedAt: null,
        failureCode: null,
        lastReceiptAt: new Date("2026-07-14T00:05:01.000Z"),
