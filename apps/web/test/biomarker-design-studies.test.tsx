...
test("design page routes the biomarker studies through the dedicated sections tab", () => {
  ...
  expect(sectionsMarkup).toContain('data-design-state="monthly-activation-desktop"');
  expect(sectionsMarkup).toContain('data-design-state="monthly-activation-mobile"');
  expect(sectionsMarkup).toContain('data-design-state="ordinary-sponsored-one-time-desktop"');
  expect(sectionsMarkup).toContain('data-design-state="ordinary-sponsored-one-time-mobile"');
  expect(sectionsMarkup).toContain('data-design-state="monthly-active-desktop"');
  expect(sectionsMarkup).toContain('data-design-state="monthly-paused-mobile"');
  expect(sectionsMarkup).toContain('data-design-state="monthly-recovery-desktop"');
  expect(sectionsMarkup).toContain('data-design-state="sponsored-one-time-recovery-desktop"');
  expect(sectionsMarkup).toContain('data-design-state="sponsored-one-time-recovery-mobile"');
