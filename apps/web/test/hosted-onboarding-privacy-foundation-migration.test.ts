...
const HOSTED_MEMBER_SCHEMA_GUARD = {
  ...
  HostedMember: [
    ...
    'callCircleMatchesAsA HostedCallCircleMatch[] @relation("HostedCallCircleMatchMemberA")',
    'callCircleMatchesAsB HostedCallCircleMatch[] @relation("HostedCallCircleMatchMemberB")',
    'callCircleParticipants HostedCallCircleParticipant[] @relation("HostedCallCircleParticipantMember")',
