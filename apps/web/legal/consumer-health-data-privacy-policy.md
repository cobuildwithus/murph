...
This Consumer Health Data Privacy Policy explains how Murph collects, uses, shares, and protects **Consumer Health Data** when you use Murph’s websites, hosted services, applications, integrations, onboarding flows, invite flows, messaging features, settings pages, APIs, and related services that link to this policy.

This policy is separate from, and supplements, Murph’s general Privacy Policy. If there is a conflict between this policy and the general Privacy Policy for Consumer Health Data, this policy controls to the extent required by applicable consumer health data privacy laws.

## 1. Scope

This policy applies only to Murph-controlled processing of Consumer Health Data. It is intended to address U.S. state consumer health data privacy laws, including Washington’s My Health My Data Act, Nevada’s consumer health data privacy law, Connecticut consumer health data provisions, and similar laws that may apply to Murph.
...
- information processed by third-party devices, wearable providers, identity providers, payment processors, messaging providers, model providers, search providers, or other integrations as independent controllers under their own privacy policies;
- information that is exempt from applicable consumer health data privacy laws, such as protected health information under HIPAA where applicable, information governed by certain medical-records laws, or properly de-identified information; or
...
For purposes of this policy, **Consumer Health Data** generally means personal information that is linked or reasonably linkable to you and that identifies your past, present, or future physical or mental health status, condition, diagnosis, treatment, health-related behavior, or health-related service use.
...
Depending on the features you use and the choices you make, Murph may collect the following categories of Consumer Health Data:
...
- **Service providers and processors**, such as hosting, security, authentication, logging, messaging, billing, support, model, search, parsing, analytics, or diagnostics providers that help Murph operate.
...
Murph may collect, use, and process Consumer Health Data for the following purposes:

- to provide Murph and the features you request;
- to create and manage accounts, sessions, settings, permissions, subscriptions, and support workflows;
- to sync, import, display, search, organize, analyze, summarize, export, or share records at your direction;
- to operate connected-service, wearable, device, messaging, invite, import, export, and automation features;
- to generate assistant responses, reminders, insights, experiment results, before-and-after analyses, protocol outputs, and other requested outputs;
- to process prompts, messages, attachments, files, transcripts, and related context;
- to communicate with you about service, security, support, onboarding, billing, account, legal, and privacy matters;
- to secure Murph, prevent misuse, detect fraud or abuse, debug issues, monitor reliability, maintain audit records, and protect users and the service;
- to comply with law, respond to legal process, enforce agreements, protect rights, and handle disputes;
- to process transactions, subscriptions, renewals, refunds, invoices, taxes, and accounting records;
...
## 7. Categories of third parties, affiliates, and processors with whom we share Consumer Health Data

Murph may share Consumer Health Data with the following categories of recipients:
...
- **Connected services and integrations you enable**, such as wearable, activity, storage, identity, communication, or other providers you authorize Murph to use.
...
- **Professional advisers and legal, compliance, and safety recipients**, such as lawyers, auditors, insurers, regulators, courts, law enforcement, or other parties where disclosure is required or permitted by law or needed to protect rights, safety, privacy, or property.
- **Successors or transaction participants**, if Murph is involved in a merger, acquisition, financing, reorganization, bankruptcy, sale of assets, or similar corporate transaction, subject to appropriate legal and confidentiality protections.

**Specific affiliates.** Murph does not currently share Consumer Health Data with any corporate affiliate. If that changes, Murph will update this policy and obtain any consent required by law before sharing Consumer Health Data with that affiliate.

Murph requires processors to process Consumer Health Data only according to Murph’s instructions, to use appropriate safeguards, to assist with consumer-rights requests where required, and to process Consumer Health Data consistently with this policy and applicable law.

## 8. Third-party collection over time and across services

Murph does not knowingly permit third parties to collect Consumer Health Data over time and across different websites or online services through Murph for targeted advertising or data-sale purposes.

Some service providers or processors may collect technical, usage, diagnostic, security, or communications information through Murph as needed to provide services to Murph or to you. These providers may process that information under their contracts with Murph and, where they act independently, under their own privacy policies.

## 9. Sale of Consumer Health Data

Murph does **not** sell Consumer Health Data.

Murph also does **not** use Consumer Health Data for targeted advertising and does **not** rent Consumer Health Data to third parties.

If Murph ever seeks to sell Consumer Health Data, Murph will not do so unless it first provides the disclosures and obtains the separate written authorization required by applicable law. Murph will not condition the provision of goods or services on signing an authorization to sell Consumer Health Data where prohibited by law.
...
Murph may update this policy from time to time. When Murph does, it will revise the “Last Updated” date above and provide any additional notice required by law.
