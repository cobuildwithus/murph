...
export const STRAVA_MEMBER_OWNED_PROVIDER_SETUP_PRESENTATION = {
  ...
  messages: {
    ...
    provider_prerequisite: "Strava requires its current developer subscription or prerequisite before an application can be created. Continue in Strava, then return here to resume.",
