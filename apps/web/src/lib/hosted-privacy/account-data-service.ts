...
async function countHostedAccountData(input: {
  ...
  const [
    ...
    input.prisma.hostedGroupDisclosurePermission.count({
      where: {
        group: {
          OR: [
            { ownerMemberId: memberIdFilter },
    ...
    input.prisma.hostedGroupDisclosureGrant.count({
      where: {
        OR: [
  ...
  return {
    ...
    "prisma.hosted_group_disclosure_permission": hostedGroupDisclosurePermission,
    "prisma.hosted_group_disclosure_grant": hostedGroupDisclosureGrant,
