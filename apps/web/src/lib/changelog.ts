...
const RAW_CHANGELOG_EDITIONS = [
  {
    ...
    summary:
      "Starter usage waits until used; patterns compare actions with next-day sleep and recovery; referral celebrations and scheduled cards stay in the intended conversation; reminders keep local time; workout rows stay clear; voice memos keep the selected voice; web search reaches current information; the homepage starts lighter; and private Environment reports preview their shape while loading.",
    items: [
      {
