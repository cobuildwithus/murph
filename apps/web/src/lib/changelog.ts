...
const RAW_CHANGELOG_EDITIONS = [
  {
    ...
    title: "Starter access, patterns, personality, reminders, and web search",
    summary:
      "Starter usage remains available until it is used, patterns compare repeated actions with next-day sleep and recovery, Murph's personality is editable in Settings or chat, reminders keep the local time you asked for, and managed OpenAI web search can reach current information again.",
    items: [
      {
