...
const RAW_CHANGELOG_EDITIONS = [
  {
    ...
    title: "Patterns, reliable reminders, steady voices, and web search",
    summary:
      "Patterns compares repeated actions with next-day sleep and recovery, reminders keep the local time you asked for, ordinary voice memos keep your selected voice, and managed OpenAI web search can reach current information again.",
    items: [
      {
