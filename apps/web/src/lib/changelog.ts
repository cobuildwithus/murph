...
const RAW_CHANGELOG_EDITIONS = [
  {
    ...
    title: "Companion access, patterns, reminders, and web search",
    summary:
      "The companion stays usable through a billing pause, Patterns compares repeated actions with next-day sleep and recovery, reminders keep the local time you asked for, and managed OpenAI web search can reach current information again.",
    items: [
      {
