...
const RAW_CHANGELOG_EDITIONS = [
  {
    ...
    title:
      "Starter access, patterns, reliable referrals, reminders, photos, cards, voices, and web search",
    summary:
      "Starter usage remains available until used, patterns compare repeated actions with next-day sleep and recovery, referral celebrations stay in their intended conversation, reminders keep the requested local time, single photos retain fine detail, completed workout rows stay clear, voice memos keep your selected voice, and managed OpenAI web search reaches current information again.",
    items: [
      {
