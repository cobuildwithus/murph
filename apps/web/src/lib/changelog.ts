    ...
    items: [
      {
        ...
        details:
          "Manual corrections are labeled Manual instead of a connected source. Reconnected sources no longer combine an old disconnected status with a newer sync time. Future-dated entries stay excluded, and missing data remains unverified.",
