...
const HOSTED_USAGE_TOP_UP_SETTINGS_URL =
...
{homeUrl}`,
  ...
  "linq.ai_usage.edge_limit_reached": [
    `You've used this month's included Edge allowance. Murph is paused until you add usage or the allowance resets. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Your included Edge usage is at its monthly amount. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `This month's Edge allowance is used. Murph is paused until you add usage or the next allowance begins. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've reached the included Edge allowance. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Edge usage is at the included monthly limit. Murph is paused until you add usage or the allowance resets. Add usage: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `The included Edge allowance is spent for this period. Murph is paused until more usage is added or the next period starts. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've used the monthly Edge allowance. Murph is paused until you add usage or the allowance resets. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Your Edge allowance has reached its included amount. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `This month's included Edge usage is used. Murph is paused until you add usage or the next allowance begins. Add usage: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've reached the Edge usage amount for this month. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `This month's Edge allowance is fully used. Murph is paused until you add usage or the allowance resets. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Edge's included usage is at its monthly limit. Murph is paused until more usage is added or the next period starts. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've used this period's Edge allowance. Murph is paused until you add usage or the allowance resets. Add usage: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `The included Edge usage has been reached. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Your monthly Edge allowance is spent. Murph is paused until you add usage or the next allowance begins. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `This period's Edge usage is at the included amount. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've reached the included monthly Edge usage. Murph is paused until you add usage or the allowance resets. Add usage: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Edge usage is at its monthly allowance. Murph is paused until more usage is added or the next period starts. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `The monthly Edge allowance is used. Murph is paused until you add usage or the allowance resets. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've used Edge's included allowance for this month. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
  ],
  "linq.ai_usage.family_limit_reached": [
    `The Family plan's included monthly allowance is used. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
    `Your shared Family allowance is at its monthly amount. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `This month's Family allowance is used. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
    `The included Family usage has been reached. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `Family usage is at the included monthly limit. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
    `The shared allowance is spent for this period. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `You've used the Family plan's monthly allowance. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
    `The shared Family allowance has reached its included amount. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `This month's included Family usage is used. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
    `You've reached the Family usage amount for this month. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `The monthly Family allowance is used. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
    `The Family plan's included usage is at its monthly limit. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `You've used this period's shared allowance. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `The included Family usage has been reached. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
    `Your monthly Family allowance is spent. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `This period's shared usage is at the included amount. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `You've reached the included monthly Family usage. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
    `Family usage is at its monthly allowance. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `The shared monthly allowance is used. Murph's AI usage is paused until the allowance resets. Account details: {homeUrl}`,
    `You've used the Family plan's included allowance for this month. Murph's AI usage is paused until the shared allowance resets. Account details: {homeUrl}`,
  ],
  "linq.ai_usage.pulse_upgrade_edge": [
    `You've used this month's included Pulse allowance. Murph is paused until you add usage or the allowance resets. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Your included Pulse usage is at its monthly amount. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `This month's Pulse allowance is used. Murph is paused until you add usage or the next allowance begins. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've reached the included Pulse allowance. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Pulse usage is at the included monthly limit. Murph is paused until you add usage or the allowance resets. Add usage: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `The included Pulse allowance is spent for this period. Murph is paused until more usage is added or the next period starts. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've used the monthly Pulse allowance. Murph is paused until you add usage or the allowance resets. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Your Pulse allowance has reached its included amount. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `This month's included Pulse usage is used. Murph is paused until you add usage or the next allowance begins. Add usage: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've reached the Pulse usage amount for this month. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `This month's Pulse allowance is fully used. Murph is paused until you add usage or the allowance resets. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Pulse's included usage is at its monthly limit. Murph is paused until more usage is added or the next period starts. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've used this period's Pulse allowance. Murph is paused until you add usage or the allowance resets. Add usage: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `The included Pulse usage has been reached. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Your monthly Pulse allowance is spent. Murph is paused until you add usage or the next allowance begins. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `This period's Pulse usage is at the included amount. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've reached the included monthly Pulse usage. Murph is paused until you add usage or the allowance resets. Add usage: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `Pulse usage is at its monthly allowance. Murph is paused until more usage is added or the next period starts. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `The monthly Pulse allowance is used. Murph is paused until you add usage or the allowance resets. Add usage in Settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
    `You've used Pulse's included allowance for this month. Murph is paused until more usage is added or the allowance resets. Usage settings: ${HOSTED_USAGE_TOP_UP_SETTINGS_URL}`,
  ],
  "linq.ai_usage.thread_limit_reached": [
