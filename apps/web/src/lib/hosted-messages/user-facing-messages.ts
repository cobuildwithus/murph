...
{homeUrl}`,
  ...
  "linq.ai_usage.group_upgrade_pulse": [
    `You've used this month's included Group AI usage. New Murph replies are paused, but your wearable keeps syncing and your group activity stays current. Pulse includes more private usage: {homeUrl}`,
    `Your Group AI allowance is used for this month. Wearable syncing and group activity keep running. Pulse has more replies, or you can wait for the reset: {homeUrl}`,
    `Group's included AI usage is at its monthly limit. I pause new replies until reset, while your wearable and group data keep updating. Pulse has more included usage: {homeUrl}`,
    `You've reached the Group plan's monthly AI allowance. Syncing stays on and your group activity remains current. Pulse is available, or wait for next period: {homeUrl}`,
    `This month's Group AI usage is used. New AI work pauses, not your wearable connection or group updates. Pulse includes more usage: {homeUrl}`,
    `Your included Group replies are used for this period. Health data keeps syncing and group activity keeps updating. Pulse is available, or wait for the reset: {homeUrl}`,
    `You've hit the Group plan's AI limit for the month. New replies pause, while wearable syncing continues and your group stays current. Pulse fits more regular private Murph usage: {homeUrl}`,
    `Group AI usage is at its included monthly amount. I pause new replies until reset, but syncing and group data continue. Pulse details: {homeUrl}`,
    `The Group allowance for new AI work is used. Your wearable remains connected and group activity stays current. Choose Pulse for more usage or wait: {homeUrl}`,
    `You've used the AI included with Group this month. Only new Murph work pauses; wearable and group updates continue. Pulse offers more included usage: {homeUrl}`,
    `Your Group plan has reached this month's AI allowance. Syncing keeps running in the background and your group data stays current. Pulse is available, or wait: {homeUrl}`,
    `That's the included Group AI usage for this period. I pause replies until reset, while your wearable and group activity continue updating. Pulse details: {homeUrl}`,
    `You've reached Group's monthly AI amount. New replies pause, while your health data still syncs and your group participation remains current. Pulse has more private replies: {homeUrl}`,
    `The Group plan's included AI is used for now. Wearable syncing does not stop, and group activity keeps updating. Pulse or the next reset will reopen replies: {homeUrl}`,
    `Your monthly Group AI allowance is spent. New replies pause, but your wearable connection and group updates stay active. Pulse details: {homeUrl}`,
    `You've used this period's Group AI allowance. New replies pause, while syncing and group activity continue normally. Pulse includes more private Murph usage: {homeUrl}`,
    `Group's monthly AI capacity is used. I pause new AI work until reset, not wearable syncing or group updates. Pulse is available if you want to keep chatting: {homeUrl}`,
    `You've reached the included usage on Group. Your wearable keeps syncing and your group data keeps moving. More Murph replies come with Pulse or the next reset: {homeUrl}`,
    `This month's Group AI allowance is complete. New replies pause, while background health syncing and group activity continue. Pulse has more included replies: {homeUrl}`,
    `Your included Group AI usage has run out for this period. New Murph replies pause, while wearables and group data stay current. Pulse is available here: {homeUrl}`,
  ],
  "linq.ai_usage.pulse_upgrade_edge": [
