...
{homeUrl}`,
  ...
  "linq.ai_usage.starter_limit_reached": [
    `You've used your free starter usage. Murph is paused until you add usage or start a plan: {homeUrl}`,
    `Your free starter usage is used. Add usage or choose a plan to keep going: {homeUrl}`,
    `You've reached the end of your free starter usage. Continue by adding usage or starting a plan: {homeUrl}`,
    `Your starter usage has run out. Murph can continue after you add usage or pick a plan: {homeUrl}`,
    `The free usage included with signup is used. Add usage or start a plan here: {homeUrl}`,
    `You've used the starter usage on your account. Add more usage or choose a plan to continue: {homeUrl}`,
    `Your free starter balance is empty. Murph is paused until you add usage or start a plan: {homeUrl}`,
    `Starter usage is used up. Add usage or choose a monthly plan here: {homeUrl}`,
    `You've reached your free starter allowance. Add usage or start a plan to keep Murph active: {homeUrl}`,
    `The starter usage on your account has been used. Add usage or choose a plan here: {homeUrl}`,
    `Your included starter usage is spent. Add usage or choose a plan to resume: {homeUrl}`,
    `You've finished the free usage that came with signup. Add usage or start a plan here: {homeUrl}`,
    `Murph is paused because your starter usage is used. Add usage or select a plan: {homeUrl}`,
    `Your starter allowance is used up. You can add usage or start a plan here: {homeUrl}`,
    `The free starter balance has reached zero. Continue by adding usage or choosing a plan: {homeUrl}`,
    `You've used the free starter allowance. Add usage or start a plan when you're ready: {homeUrl}`,
    `Your account's starter usage is gone. Add usage or choose a plan to keep going: {homeUrl}`,
    `Starter usage has been used. Murph can resume after you add usage or start a plan: {homeUrl}`,
    `You've reached the starter usage limit. Add usage or pick a plan here: {homeUrl}`,
    `Your free starter usage is complete. Add usage or choose a plan to continue: {homeUrl}`,
  ],
  "linq.ai_usage.edge_limit_reached": [
