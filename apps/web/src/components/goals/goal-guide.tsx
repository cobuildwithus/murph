...
export function GoalGuide({
  ...
  return (
    <article className="mx-auto w-full max-w-4xl pb-12">
      ...
      <header className="border-b border-border/70 pb-10">
        <div className="grid gap-8 sm:grid-cols-[minmax(0,1fr)_8rem] sm:items-start">
          ...
          <GoalCategoryArtwork
            ...
            className="hidden size-32 sm:flex"
            imageClassName="p-3"
            preload
          />
        </div>
      ...
      <MarkdownView
        content={goal.body}
        className="max-w-3xl pt-8 text-base/7 text-foreground/90 [&_a]:font-medium [&_a]:text-primary [&_a]:underline [&_a]:decoration-primary/30 [&_a]:underline-offset-4 [&_a:hover]:decoration-primary [&_blockquote]:my-6 [&_blockquote]:border-l-2 [&_blockquote]:border-border [&_blockquote]:pl-5 [&_blockquote]:text-muted-foreground [&_h2]:mb-3 [&_h2]:mt-10 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-foreground [&_h3]:mb-2 [&_h3]:mt-7 [&_h3]:font-serif [&_h3]:text-lg [&_h3]:font-semibold [&_li]:my-2 [&_ol]:my-5 [&_ol]:list-decimal [&_ol]:space-y-1 [&_ol]:pl-6 [&_p]:my-4 [&_strong]:font-semibold [&_strong]:text-foreground [&_ul]:my-5 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-6"
      />
