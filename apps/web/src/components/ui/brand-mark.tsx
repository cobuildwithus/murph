...
export function BrandMark({ href = "/home", className }: { href?: string; className?: string }) {
  return (
    <Link href={href} aria-label="Murph" className={cn("group/brand flex items-center px-2 py-1", className)}>
