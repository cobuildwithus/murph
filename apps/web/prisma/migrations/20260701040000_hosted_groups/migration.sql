...
CREATE INDEX "hosted_group_owner_member_id_status_idx" ON "hosted_group"("owner_member_id", "status");
CREATE INDEX "hosted_group_kind_status_idx" ON "hosted_group"("kind", "status");
CREATE UNIQUE INDEX "hosted_group_member_group_id_member_id_key" ON "hosted_group_member"("group_id", "member_id");
CREATE INDEX "hosted_group_member_member_id_status_idx" ON "hosted_group_member"("member_id", "status");
CREATE INDEX "hosted_group_member_group_id_status_idx" ON "hosted_group_member"("group_id", "status");
