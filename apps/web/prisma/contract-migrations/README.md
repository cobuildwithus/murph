...
them before build. Contract changes such as `DROP COLUMN`, `DROP TABLE`, or
other destructive cleanup belong here so GitHub can run them after Vercel
reports the production deployment as successful.
