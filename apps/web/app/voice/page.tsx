...
export default function VoicePage() {
  ...
  return (
    <main className="flex min-h-svh flex-col items-center justify-center bg-background px-6 py-12 text-foreground">
      ...
      <p className="mt-5 max-w-sm text-center text-sm leading-6 text-muted-foreground">Start with Gleam, or try a different accent.<br />Talk naturally. Click the circle to pause.</p>
