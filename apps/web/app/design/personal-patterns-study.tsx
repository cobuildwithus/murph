...
const POPULATED_REPORT: PersonalPatternReport = {
  ...
  factors: [
    ...
    { id: "late-meal", kind: "intervention", label: "Late meal", observedDays: 7 },
    { id: "custom-tag", kind: "intervention", label: "Custom tag", observedDays: 6 },
  ],
  outcomes: [
  ...
  cells: [
    ...
    cell("late-meal", "resting-heart-rate", "no_clear_pattern", "flat", 0.5, 54.9, 54.6, 6),
    cell("custom-tag", "hrv", "no_clear_pattern", "flat", 0.1, 43.9, 43.8, 5),
    cell("custom-tag", "total-sleep", "no_clear_pattern", "flat", 0.3, 428, 427, 5),
    cell("custom-tag", "resting-heart-rate", "no_clear_pattern", "flat", 0.4, 54.8, 54.6, 5),
  ],
  lagDays: 1,
