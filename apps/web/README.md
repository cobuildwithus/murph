...
- `RESEND_API_KEY`, `HOSTED_SIGNUP_WELCOME_EMAIL_FROM`, and `HOSTED_SIGNUP_WELCOME_EMAIL_FOUNDER_NAME` enable the post-activation signup welcome email to the member's verified email address. Leave any of them unset to disable the send path.
