...
Generated research configs are self-contained for the workspace package script and managed browser profile; they do not inherit the repo-wide `review:gpt` packaging defaults.

For discovery and source-ledger reduction seams, the canonical local truth is the downloaded machine-readable artifact under `downloads/<label>/...`, not just the prose response markdown.
