...
- prefer the smallest high-leverage fix that simplifies the package graph today
...
- do not invent new packages or broad architecture churn unless the current graph clearly justifies it
...
- do not stop at prose if you can safely land a real fix in code
- choose the smallest patch that fixes remaining package-boundary leaks, circular dependencies, or mixed-concern ownership problems
