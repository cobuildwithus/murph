...
const MODEL_CANDIDATE_DEFINITIONS = {
  ...
  body_only_no_crp: {
    ...
    hypothesis: "BMI may add a parsimonious body-size increment over demographics.",
    hypothesisSource: "literature or mechanistic rationale",
  },
  glycemia_only_no_crp: {
    candidateRole: "proposal",
    featureKeys: ["age", "male", "hba1c"],
    hypothesis: "Glycemia may add a parsimonious metabolic increment over demographics.",
    hypothesisSource: "literature or mechanistic rationale",
  },
