...
private protected job derives the live Current and Ramping reader SHAs and owns
integration, replay, canary, and deployment admission. The completed execution
snapshot and subagent prompt record is
