...
similarity scoring, canonical-key deduplication, and window sorting; exact-id
and UPC lookups retain their direct indexed paths. The public projection of that
database is Murph Safe at `/search` and the
