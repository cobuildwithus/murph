...
- install or check the Temporal CLI with `pnpm temporal:cli:setup` or `pnpm temporal:cli:check`; `pnpm dev` and hosted-local E2E manage the local Temporal dev server and worker automatically
