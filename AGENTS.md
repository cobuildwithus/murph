...
- Required completion-workflow audit passes are mandatory for repo task classes that require them. They are repo-policy pre-authorized, and they must run before handoff rather than being treated as optional close-out checks after implementation, verification, or even a scoped commit.
