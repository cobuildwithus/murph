...
- Before implementing any frontend change, think through the UX and choose the simplest complete implementation that preserves required behavior, states, accessibility, responsiveness, and recovery.
