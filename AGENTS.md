...
- Do not create or extend hand-authored repo files beyond 1,000 lines. When implementation/docs/test/config work touches an oversized hand-authored file, split it along composable ownership seams first; details live in `agent-docs/references/giant-file-composability-seams.md`.
