...
- Before adding database-touching collection work, apply `docs/contracts/00-invariants.md` § Database Load And Collection Fanout and evaluate its composed peak load at maximum admitted cardinality.
