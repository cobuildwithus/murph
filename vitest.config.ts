...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: /^@murph\/assistant-services$/, replacement: path.resolve("packages/assistant-services/src/index.ts") },
      { find: "@murph/assistant-services/automation", replacement: path.resolve("packages/assistant-services/src/automation.ts") },
      { find: "@murph/assistant-services/cron", replacement: path.resolve("packages/assistant-services/src/cron.ts") },
      { find: "@murph/assistant-services/inbox-services", replacement: path.resolve("packages/assistant-services/src/inbox-services.ts") },
      { find: "@murph/assistant-services/operator-config", replacement: path.resolve("packages/assistant-services/src/operator-config.ts") },
      { find: "@murph/assistant-services/outbox", replacement: path.resolve("packages/assistant-services/src/outbox.ts") },
      { find: "@murph/assistant-services/runtime", replacement: path.resolve("packages/assistant-services/src/runtime.ts") },
